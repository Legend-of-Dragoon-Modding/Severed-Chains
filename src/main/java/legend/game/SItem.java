...
public final class SItem {
  ...
  public static void allocatePlayerBattleObjects() {
    ...
    for(int charSlot = 0; charSlot < charCount_800c677c.get(); charSlot++) {
      ...
      final ScriptState<PlayerBattleObject> state = SCRIPTS.allocateScriptState(charSlot + 6, name, 0, new PlayerBattleObject(name));
      ...
      _8006e398.charBobjs_e40[charSlot] = state;
    ...
    _8006e398.charBobjs_e40[charCount_800c677c.get()] = null;
...
//    loadSupportOverlay(2, () -> SItem.loadEnemyTextures(2625 + encounterId_800bb0f8.get()));
    ...
    for(int i = 0; i < charCount_800c677c.get(); i++) {
      combatants_8005e398[_8006e398.charBobjs_e40[i].innerStruct_00.combatantIndex_26c].flags_19e |= 0x2a;
    }
  ...
  public static void loadCharTmdAndAnims(final List<FileData> files, final int charSlot) {
    //LAB_800fc260
    final BattleObject27c data = _8006e398.charBobjs_e40[charSlot].innerStruct_00;
  ...
  public static void loadCharacterTim(final FileData file, final int charSlot) {
    final BattleObject27c bobj = _8006e398.charBobjs_e40[charSlot].innerStruct_00;
