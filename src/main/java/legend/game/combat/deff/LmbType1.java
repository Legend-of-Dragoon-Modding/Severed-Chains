...
public class LmbType1 extends Lmb {
  ...
  public LmbType1(final FileData data) {
    ...
    this._14 = new short[this._08 * (this.keyframeCount_0a - 1) / 2]; // Number of bytes, /2 to get array length
  ...
  public static class Sub04 {
    public final int transformsType_00;
    public final int _03;

    public Sub04(final FileData data) {
      this.transformsType_00 = data.readUShort(0x0);
