...
import static legend.game.combat.Bttl_800e.*;
...
*/
  ...
  @Method(0x800dc630L)
  public static long FUN_800dc630(final long a0, final long a1, final long a2, final long a3, final long a4) {
    final long v1 = FUN_800dd02c(a1);

    if(a0 == 0) {
      //LAB_800dc698
      return a2 - MEMORY.ref(4, v1).offset(0x0L).get();
    }

    if(a0 == 0x1L) {
      //LAB_800dc6a4
      return a3 - MEMORY.ref(4, v1).offset(0x4L).get();
    }

    if(a0 == 0x2L) {
      //LAB_800dc6b0
      return a4 - MEMORY.ref(4, v1).offset(0x8L).get();
    }
  ...
  public static void FUN_800de3f4(final long a0, final BttlScriptData6cInner a1, final MATRIX a2) {
    ...
    if((s0 & (sp0x10.transfer.getZ() ^ _800bb0fc.get())) == 0 || sp0x10.transfer.getZ() - sp0x10.transfer.getX() >= -0x800L && sp0x10.transfer.getZ() + sp0x10.transfer.getX() >= -0x800L && sp0x10.transfer.getZ() - sp0x10.transfer.getY() >= -0x800L && sp0x10.transfer.getZ() + sp0x10.transfer.getY() >= -0x800L) {
      ...
      final long[] sp0x30 = {a0, 0, a1._00.get()};
      FUN_800e3e6c(sp0x30);
    }
