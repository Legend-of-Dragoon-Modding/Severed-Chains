...
public final class SEffe {
  ...
  public static void FUN_80101d3c(final EffectData98 a0, final EffectData98Sub94 a1, final EffectData98Inner24 a2, final long a3) {
    ...
    if((a3 & 0xf_ff00L) == 0xf_ff00L) {
      ...
      a0.tmd_30.set(tmds_800c6944[(int)a3 & 0xff]);
...
//        MEMORY.ref(4, v1).offset(0x4L).setu(0x2c80_8080L);
    ...
    //LAB_80101f70
    if((a3 & 0xf_ff00L) == 0xf_ff00L) {
      final SpriteMetrics08 metrics = spriteMetrics_800c6948[(int)(a3 & 0xff)];
...
//      sp10 = MEMORY.ref(2, v0).offset(0xaL).get();
  ...
  public static FlowControl FUN_801114b8(final RunningScript a0) {
    ...
    if((s2 & 0xf_ff00L) == 0xf_ff00L) {
      s1.part_14.set(deffManager_800c693c._390[s2 & 0xff]);
    } else {
      //LAB_801115b4
...
//    return _800bf0cf.get() != a0.params_20.get(0).deref().get() ? 2 : 0;
  ...
  public static void FUN_80115c2c(final int a0, final int a1) {
    final int scriptIndex = allocateEffectManager(deffManager_800c693c.scriptIndex_1c, 0, MEMORY.ref(4, getMethodAddress(SEffe.class, "FUN_80115b2c", int.class, ScriptState.classFor(EffectManagerData6c.class), EffectManagerData6c.class), TriConsumerRef::new), null, MEMORY.ref(4, getMethodAddress(SEffe.class, "FUN_80115bf0", int.class, ScriptState.classFor(EffectManagerData6c.class), EffectManagerData6c.class), TriConsumerRef::new), null);
    final ScriptState<?> state = scriptStatePtrArr_800bc1c0[scriptIndex];
  ...
  public static long FUN_80115cac(final int a0) {
    ...
    if(currentStage_800c66a4.get() < 71 || currentStage_800c66a4.get() > 78) {
      ...
      if(a0 == 0) {
        ...
        //LAB_80115de8
        stage_800bda0c.deref()._5e4.and(~(_00 | _02 | _04));
        //LAB_80115da8
      } else if(a0 == 1) {
        //LAB_80115e18
        stage_800bda0c.deref()._5e4.or(_00);
      } else if(a0 == 2) {
        //LAB_80115e34
        stage_800bda0c.deref()._5e4.or(_02);
        ...
        //LAB_80115e70
        //LAB_80115e8c
        stage_800bda0c.deref()._5e4.or(_04);
      }
    }
...
//          h = MEMORY.ref(2, v0).offset(0x6L).getSigned();
    ...
    if(a0 == 0x300_0000L) {
      ...
      if(effect._48.get() == a2) {
        ...
        if((a2 & 0xf_ff00) == 0xf_ff00) {
          sp8c = deffManager_800c693c.tmds_2f8[a2 & 0xff];
        } else {
          //LAB_80116750
          //TODO
  ...
  public static FlowControl FUN_80117eb0(final RunningScript script) {
    ...
    if((param1 & 0xf_ff00) == 0xf_ff00) {
      deffPart = deffManager_800c693c._390[param1 & 0xff].getAddress();
    } else {
      //LAB_80117f58
  ...
  public static FlowControl allocateGuardHealEffect(final RunningScript script) {
    ...
    if((s1 & 0xf_ff00) == 0xf_ff00) {
      effect._04.set(0);
      effect.tmd_08.set(deffManager_800c693c.tmds_2f8[(int)s1 & 0xff]);
      effect._10.set(0x20);
    } else {
      //LAB_8011847c
  ...
  public static void FUN_801186f8(final long a0, final long a1) {
    ...
    if((a1 & 0xf_ff00L) == 0xf_ff00L) {
      ...
      MEMORY.ref(4, a0).offset(0x8L).setu(deffManager_800c693c.tmds_2f8[(int)(a1 & 0xff)].getAddress()); //TODO
    } else {
      //LAB_80118750
