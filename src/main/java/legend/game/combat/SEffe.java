...
public final class SEffe {
  ...
  public static void FUN_80101d3c(final EffectData98 a0, final EffectData98Sub94 a1, final EffectData98Inner24 a2, final long flags) {
    ...
    if((flags & 0xf_ff00) == 0xf_ff00) {
      ...
      a0.tmd_30.set(tmd.tmd.objTable[0]);
      a0.tpage_56.set((int)((tmd.id & 0xffff_0000L) >>> 11));
    }
...
//        MEMORY.ref(4, v1).offset(0x4L).setu(0x2c80_8080L);
    ...
    if((flags & 0xf_ff00) == 0xf_ff00) {
      ...
      a0.u_58.set(deffMetrics.u_00);
      a0.v_5a.set(deffMetrics.v_02);
      a0.w_5e.set(deffMetrics.w_04 * 4);
      a0.h_5f.set(deffMetrics.h_06);
      a0.clut_5c.set(GetClut(deffMetrics.clutX_08, deffMetrics.clutY_0a));
    }
  ...
  public static FlowControl FUN_8010a3fc(final RunningScript<? extends BattleScriptDataBase> script) {
    ...
    final long vertexCount = tmd.n_vert_04;
    final long normalCount = tmd.n_normal_0c;

    final SVECTOR[] vertices = tmd.vert_top_00;
    final SVECTOR[] normals = tmd.normal_top_08;

    effect.vertexCount_00.set(vertexCount);
    effect.normalCount_04.set(normalCount);
    effect.primitiveCount_08.set(tmd.n_primitive_14);
    ...
    for(int t0 = 0; t0 < vertexCount; t0++) {
      //LAB_8010a54c
      effect.verticesCopy_1c.deref().get(t0).set(vertices[t0]);
    }
    ...
    for(int t0 = 0; t0 < normalCount; t0++) {
      //LAB_8010a59c
      effect.normalsCopy_20.deref().get(t0).set(normals[t0]);
    }
  ...
  public static FlowControl allocateGoldDragoonTransformEffect(final RunningScript<? extends BattleScriptDataBase> script) {
    ...
    for(int i = 0; i < count; i++) {
      ...
      if((s7 & 0xf_ff00) == 0xf_ff00) {
        ...
        instance.tmd_70.set(tmdType.tmd_0c.tmdPtr_00.tmd.objTable[0]);
      }
  ...
  public static FlowControl FUN_8010edc8(final RunningScript<? extends BattleScriptDataBase> script) {
    ...
    for(int i = 0; i < count; i++) {
      ...
      MEMORY.ref(4, addr).offset(0x94L).setu(((DeffPart.TmdType)getDeffPart(sp18 | 0x300_0000)).tmd_0c.tmdPtr_00.tmd.objTable[0].getAddress());
      MEMORY.ref(4, addr).offset(0x98L).setu(((DeffPart.TmdType)getDeffPart(sp1c | 0x300_0000)).tmd_0c.tmdPtr_00.tmd.objTable[0].getAddress());
      MEMORY.ref(4, addr).offset(0x9cL).setu(((DeffPart.TmdType)getDeffPart(sp20 | 0x300_0000)).tmd_0c.tmdPtr_00.tmd.objTable[0].getAddress());
      addr += 0xa8L;
    }
      ...
      for(int i = 0; i < effect.count_00.get(); i++) {
        if(MEMORY.ref(1, s3).offset(0x00L).get() != 0) {
          ...
          if(MEMORY.ref(1, s3).offset(0x01L).get() != 0) {
            sp0xf8.tmd_08 = MEMORY.ref(4, MEMORY.ref(4, s3).offset(0x98L).get(), TmdObjTable1c::new);
          ...
          if(v1 < 9) {
            sp0xf8.tmd_08 = MEMORY.ref(4, MEMORY.ref(4, s3).offset(0x94L).get(), TmdObjTable1c::new);
            Renderer.renderDobj2(sp0xf8, false);
          } else if(v1 >= 11) {
            sp0xf8.tmd_08 = MEMORY.ref(4, MEMORY.ref(4, s3).offset(0x9cL).get(), TmdObjTable1c::new);
            Renderer.renderDobj2(sp0xf8, false);
          }
...
//          h = MEMORY.ref(2, v0).offset(0x6L).getSigned();
  ...
  public static void processLmbType1(final EffectManagerData6c manager, final BttlScriptData6cSub5c effect, final int t0, final MATRIX matrix) {
    ...
    final long fp = lmb.getAddress() + MEMORY.ref(4, lmb.getAddress()).offset(0xcL).get(); //TODO
    int a0 = t0 / 0x2000;
    int s0 = t0 & 0x1fff;
    int s5 = (a0 + 1) % lmb._0a;
    ...
    if(effect._04 != t0) {
      ...
      //LAB_80116c20
      if(a0 == 0) {
        memcpy(s7.getAddress(), lmb._10.getAddress(), lmb.count_04 * 0x14);
      } else {
        //LAB_80116c50
        final long t1 = (a0 - 1) * lmb._08;
        long a0_0 = lmb.getAddress() + MEMORY.ref(4, lmb.getAddress()).offset(0x14L).get() + t1; //TODO
        long v1 = fp;
        ...
        for(int i = 0; i < lmb.count_04; i++) {
          ...
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x8000) == 0) {
            transforms.scale_00.setX((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116ca0
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x4000) == 0) {
            transforms.scale_00.setY((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116cc0
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x2000) == 0) {
            transforms.scale_00.setZ((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116ce0
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x1000) == 0) {
            transforms.trans_06.setX((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116d00
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x800) == 0) {
            transforms.trans_06.setY((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116d20
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x400) == 0) {
            transforms.trans_06.setZ((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116d40
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x200) == 0) {
            transforms.rot_0c.setX((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116d60
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x100) == 0) {
            transforms.rot_0c.setY((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }

          //LAB_80116d80
          if((MEMORY.ref(2, v1).offset(0x0L).get() & 0x80) == 0) {
            transforms.rot_0c.setZ((short)MEMORY.ref(2, a0_0).offset(0x0L).get());
            a0_0 = a0_0 + 0x2L;
          }
      ...
      //LAB_80116db8
      long a0_0 = lmb.getAddress() + MEMORY.ref(4, lmb.getAddress()).offset(0x14L).get() + (s5 - 1) * lmb._08; //TODO
      long a2 = fp;
      ...
      for(int i = 0; i < lmb.count_04; i++) {
        ...
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x8000) == 0) {
          transforms.scale_00.setX((short)((transforms.scale_00.getX() * s1 + MEMORY.ref(2, a0_0).offset(0x0L).getSigned() * s0) / 0x2000));
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116e34
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x4000) == 0) {
          transforms.scale_00.setY((short)((transforms.scale_00.getY() * s1 + MEMORY.ref(2, a0_0).offset(0x0L).getSigned() * s0) / 0x2000));
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116e80
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x2000) == 0) {
          transforms.scale_00.setZ((short)((transforms.scale_00.getZ() * s1 + MEMORY.ref(2, a0_0).offset(0x0L).getSigned() * s0) / 0x2000));
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116ecc
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x1000) == 0) {
          transforms.trans_06.setX((short)((transforms.trans_06.getX() * s1 + MEMORY.ref(2, a0_0).offset(0x0L).getSigned() * s0) / 0x2000));
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116f18
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x800) == 0) {
          transforms.trans_06.setY((short)((transforms.trans_06.getY() * s1 + MEMORY.ref(2, a0_0).offset(0x0L).getSigned() * s0) / 0x2000));
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116f64
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x400) == 0) {
          transforms.trans_06.setZ((short)((transforms.trans_06.getZ() * s1 + MEMORY.ref(2, a0_0).offset(0x0L).getSigned() * s0) / 0x2000));
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116fb0
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x200) == 0) {
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116fc8
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x100) == 0) {
          a0_0 = a0_0 + 0x2L;
        }

        //LAB_80116fd4
        if((MEMORY.ref(2, a2).offset(0x0L).get() & 0x80) == 0) {
          a0_0 = a0_0 + 0x2L;
        }
    ...
    for(int i = 0; i < lmb.count_04; i++) {
      ...
      final int deffFlags = effect._14[(int)MEMORY.ref(1, fp).offset(i * 0x4L).offset(0x3L).get()];
      if(deffFlags != 0) {
  ...
  public static void processLmbType2(final EffectManagerData6c manager, final BttlScriptData6cSub5c effect, final int t5, final MATRIX matrix) {
    ...
    if(effect._04 != t5) {
      ...
      //LAB_8011720c
      for(; s1 < s6; s1++) {
        long a0 = lmb.getAddress() + MEMORY.ref(4, lmb.getAddress()).offset(0x14L).get() + s1 * lmb._08; //TODO
      ...
      if(fp == 0) {
        ...
        long a0_0 = lmb.getAddress() + MEMORY.ref(4, lmb.getAddress()).offset(0x14L).get() + (fp - 1) * lmb._08; //TODO
  ...
  public static void FUN_801186f8(final long a0, final int flags) {
    ...
    if((flags & 0xf_ff00L) == 0xf_ff00L) {
      ...
      MEMORY.ref(4, a0).offset(0x8L).setu(tmdWithId.tmd.objTable[0].getAddress());
      MEMORY.ref(2, a0).offset(0x10L).setu((tmdWithId.id & 0xffff_0000L) >>> 11);
    }
