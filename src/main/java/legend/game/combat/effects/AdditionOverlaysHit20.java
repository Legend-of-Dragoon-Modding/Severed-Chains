...
public class AdditionOverlaysHit20 implements MemoryRef {
  ...
  public final ByteRef _00; // Set to 1, never used?
  public final ByteRef hitSuccessful_01;
  public final ByteRef _02; // Set only to 3?
  ...
  public final ByteRef isCountered_1c;
  ...
  public AdditionOverlaysHit20(final Value ref) {
    ...
    this.isCountered_1c = ref.offset(1, 0x1c).cast(ByteRef::new);
  }
