...
public class BttlScriptData6cSub38Sub14Sub30 implements MemoryRef {
  ...
  public final USCOLOUR colour_10;
  public final USCOLOUR colour_16;
  public final USCOLOUR _1c;
  public final USCOLOUR _22;
  ...
  public BttlScriptData6cSub38Sub14Sub30(final Value ref) {
    ...
    this.colour_10 = ref.offset(2, 0x10L).cast(USCOLOUR::new);
    this.colour_16 = ref.offset(2, 0x16L).cast(USCOLOUR::new);
    this._1c = ref.offset(2, 0x1cL).cast(USCOLOUR::new);
    this._22 = ref.offset(2, 0x22L).cast(USCOLOUR::new);
