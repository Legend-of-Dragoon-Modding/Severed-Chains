...
public class BattleStage implements MemoryRef {
  ...
  public final ShortRef partCount_5dc;
  ...
  public BattleStage(final Value ref) {
    this.ref = ref;
    ...
    this.partCount_5dc = ref.offset(2, 0x5dcL).cast(ShortRef::new);
