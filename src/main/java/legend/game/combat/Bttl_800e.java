...
import static legend.game.combat.SBtld._80112068;
...
public final class Bttl_800e {
        ...
        if((int)t3 >= 0) {
          ...
          if((int)t3 > 0 || t8 != 0 && t3 != 0) {
            ...
            if((int)t0 >= 0xbL) {
              ...
              CPU.COP2(0x118043fL);
              MEMORY.ref(4, a0).offset(-0x7L).setu(s8);
  ...
  public static void FUN_800e5a78(final int index, final ScriptState<BttlScriptData6c> state, final BttlScriptData6c struct) {
    ...
    for(int i = 0; i < 3; i++) {
      ...
      if(v1 == 0x1L) {
        ...
        sp0x10.set(scriptStatePtrArr_800bc1c0.get(a2.scriptIndex_38.get()).deref().innerStruct_00.derefAs(BtldScriptData27c.class)._148.coord2Param_64.rotate).add(a2.vec_04);
    ...
    switch(a0.params_20.get(0).deref().get() & 0xffff) {
      ...
      case 4 -> {
        ...
        switch((int)_800fafe8.get()) {
          ...
          case 2:
          case 3:
            FUN_80015d38(_800c6938.deref(4).offset(0x18L).get());
  ...
  public static int FUN_800e80c4(final int a0, final long subStructSize, @Nullable final TriConsumerRef<Integer, ScriptState<BttlScriptData6c>, BttlScriptData6c> a2, @Nullable final TriConsumerRef<Integer, ScriptState<BttlScriptData6c>, BttlScriptData6c> callback08, @Nullable final TriConsumerRef<Integer, ScriptState<BttlScriptData6c>, BttlScriptData6c> a4, @Nullable final Function<Value, BttlScriptData6cSubBase1> subStructConstructor) {
    ...
    if(a0 != -1) {
      final int a0_0;
      if(scriptStatePtrArr_800bc1c0.get(a0).deref().innerStruct_00.derefAs(BattleScriptDataBase.class).magic_00.get() != 0x2020_4d45L) {
  ...
  public static <T extends MemoryRef> int FUN_800e832c(final int a0, final long subStructSize, final long a2, @Nullable final TriConsumerRef<Integer, ScriptState<T>, T> callback08, final long a4) {
    ...
    if(a0 != -1) {
      final int a0_0;
      if(scriptStatePtrArr_800bc1c0.get(a0).deref().innerStruct_00.derefAs(BtldScriptData27c.class).magic_00.get() == 0x2020_4d45L) {
        a0_0 = a0;
      } else {
  ...
  public static void FUN_800e883c(final int a0, final int a1) {
    ...
    if(a0 != _800c693c.deref(4).offset(0x1cL).getSigned() && a0 != a1) {
      if((s3._04.get() & 0x4_0000L) == 0 && (s3._04.get() & 0xff00_0000L) != 0x200_0000L) {
        ...
        //LAB_800e8a50
        final long addr1 = addToLinkedListTail(0x16cL); //TODO gonna have to initialize BttlScriptData6c?
        ...
        if(addr2 < addr1) {
          ...
          scriptStatePtrArr_800bc1c0.get(a0).setPointer(addr1);
          MEMORY.ref(4, addr1).offset(0x0L).setu(addr1 + 0x100L);
        } else {
          //LAB_800e8ad4
          removeFromLinkedList(addr1);
        }
...
//        primitives += primitiveCount * 0x2cL;
  ...
  public static void FUN_800ee610() {
    ...
    _800c6c34.setPointer(addToLinkedListTail(0x58L));
  ...
  public static void FUN_800eee80(long a0) {
    ...
    //LAB_800eeecc
    for(int i = 0; i < 3; i++) {
      final LodString a0_0 = _80112068.get((int)sp0x10[i]).deref();
    ...
    final BtldScriptData27c a1 = scriptStatePtrArr_800bc1c0.get((int)a0).deref().innerStruct_00.derefAs(BtldScriptData27c.class);
    final LodString a0_0 = _80112068.get(a1._272.get()).deref();

    //LAB_800eef7c
    for(int charIndex = 0; ; charIndex++) {
      _800c69d0.get((int)_800c6b9c.get()).charAt(charIndex, a0_0.charAt(charIndex));
    ...
    final long v1 = _8010ba98.offset(a1._272.get() * 0x1cL).getAddress();
  ...
  public static void FUN_800ef28c(long a0) {
    ...
    for(int charIndex = 0; charIndex < Math.min(_800c677c.get(), 3); charIndex++) {
      final BtldScriptData27c s0 = scriptStatePtrArr_800bc1c0.get((int)_8006e398.offset(4, 0xe40L).offset(charIndex * 0x4L).get()).deref().innerStruct_00.derefAs(BtldScriptData27c.class);
      final byte[] sp0x10 = new byte[9];
      FUN_80022928(sp0x10, s0._272.get());
      _800c6960.offset(charIndex * 0x9L).offset(1, 0x0L).setu(s0._272.get());
      ...
      final ActiveStatsa0 stats = stats_800be5f8.get(s0._272.get());
  ...
  public static void FUN_800ef8d8(long a0) {
    ...
    MEMORY.ref(2, a0_0).offset(0x02L).setu(scriptStatePtrArr_800bc1c0.get((int)_8006e398.offset(0xe40L).offset(a0 * 0x4L).get()).deref().innerStruct_00.derefAs(BtldScriptData27c.class)._272.get());
      ...
      for(int i = 0; i < s4; i++) {
        if(MEMORY.ref(2, s2).offset(0x0L).getSigned() != -1) {
          ...
          if((v1 & 0x1L) != 0 && (v1 & 0x2L) != 0) {
            final BtldScriptData27c data = scriptStatePtrArr_800bc1c0.get((int)_8006e398.offset(0xe40L).offset(i * 0x4L).get()).deref().innerStruct_00.derefAs(BtldScriptData27c.class);
  ...
  public static void FUN_800efd34() {
    ...
    if((int)_800c6cf4.get() >= 0x6L) {
      ...
      if(struct58._4c.get() != 0) {
        ...
        LodString str;
        if((int)a1 == -0x1L) {
          str = _800fb36c.get((int)struct58._50.get()).deref();
          spf0 = 0x3L;
          textLen(str);
        } else {
