...
public final class Bttl_800e {
  ...
  public static void FUN_800ef28c(final long a0) {
    ...
    for(int charSlot = 0; charSlot < charCount_800c677c.get(); charSlot++) {
      ...
      s0.hpRegen_132.set(stats._56.get());
      s0.mpRegen_134.set(stats.hpRegen_58.get());
      s0.spRegen_136.set(stats.mpRegen_5a.get());
      s0.revive_138.set(stats.spRegen_5c.get());
      s0._13a.set(stats.revive_5e.get());
      s0._13c.set(stats.hpMulti_62.get());
      s0._13e.set(stats.mpMulti_64.get());
