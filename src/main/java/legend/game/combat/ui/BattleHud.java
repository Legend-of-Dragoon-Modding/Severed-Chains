...
public class BattleHud {
  ...
  private int getItemOrSpellId() {
    if(this.spellAndItemMenu_800c6b60.menuType_0a == 0) {
      //LAB_800f56f0
      final ItemIdEvent itemId = EVENTS.postEvent(new ItemIdEvent(LodMod.idItemMap.getInt(this.combatItems_800c6988.get(this.spellAndItemMenu_800c6b60.listIndex_24 + this.spellAndItemMenu_800c6b60.listIndex_24).item.getRegistryId()), this.combatItems_800c6988.get(this.spellAndItemMenu_800c6b60.listScroll_24 + this.spellAndItemMenu_800c6b60.listIndex_1e).item.getRegistryId()));
      lastItemSelected = this.combatItems_800c6988.get(this.spellAndItemMenu_800c6b60.listScroll_1e + this.spellAndItemMenu_800c6b60.listScroll_1e).item;
