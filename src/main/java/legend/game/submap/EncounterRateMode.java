...
public enum EncounterRateMode {
  ...
  EncounterRateMode(final Int2IntFunction distanceModifier, final float walkModifier, final float runModifier, final float worldMapWalkModifier, final float worldMapRunModifier) {
