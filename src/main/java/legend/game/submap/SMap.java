...
public class SMap extends EngineState {
  ...
  public static final ShopStruct40[] shops_800f4930 = {
    LodShops.BALE_EQUIPMENT_CASTLE.get(),
    LodShops.SERDIO_ITEM_SHOP.get(),
    LodShops.LOHAN_EQUIPMENT_SHOP.get(),
    LodShops.LOHAN_ITEM_SHOP.get(),
    LodShops.KAZAS_EQUIPMENT_SHOP.get(),
    LodShops.KAZAS_FORT_ITEM_SHOP.get(),
    LodShops.FLETZ_EQUIPMENT_SHOP.get(),
    LodShops.FLETZ_ITEM_SHOP.get(),
    LodShops.DONAU_EQUIPMENT_SHOP.get(),
    LodShops.DONAU_ITEM_SHOP.get(),
    LodShops.QUEEN_FURY_EQUIPMENT_SHOP.get(),
    LodShops.QUEEN_FURY_ITEM_SHOP.get(),
    LodShops.FUENO_EQUIPMENT_SHOP.get(),
    LodShops.FUENO_ITEM_SHOP.get(),
    LodShops.FURNI_EQUIPMENT_SHOP.get(),
    LodShops.FURNI_ITEM_SHOP.get(),
    LodShops.DENINGRAD_EQUIPMENT_SHOP.get(),
    LodShops.DENINGRAD_ITEM_SHOP.get(),
    LodShops.WINGLY_FOREST_EQUIPMENT_SHOP.get(),
    LodShops.WINGLY_FOREST_ITEM_SHOP.get(),
    LodShops.VELLWEB_EQUIPMENT_SHOP.get(),
    LodShops.VELLWEB_ITEM_SHOP.get(),
    LodShops.ULARA_EQUIPMENT_SHOP.get(),
    LodShops.ULARA_ITEM_SHOP.get(),
    LodShops.ROUGE_EQUIPMENT_SHOP.get(),
    LodShops.ROUGE_ITEM_SHOP.get(),
    LodShops.MOON_EQUIPMENT_SHOP.get(),
    LodShops.MOON_ITEM_SHOP.get(),
    LodShops.HELLENA_01_ITEM_SHOP.get(),
    LodShops.KASHUA_EQUIPMENT_SHOP.get(),
    LodShops.KASHUA_ITEM_SHOP.get(),
    LodShops.FLETZ_ACCESSORY_SHOP.get(),
    LodShops.FOREST_ITEM_SHOP.get(),
    LodShops.KAZAS_FORT_EQUIPMENT_SHOP.get(),
    LodShops.VOLCANO_ITEM_SHOP.get(),
    LodShops.ZENEBATOS_EQUIPMENT_SHOP.get(),
    LodShops.ZENEBATOS_ITEM_SHOP.get(),
    LodShops.HELLENA_02_ITEM_SHOP.get(),
    LodShops.UNKNOWN_SHOP_01.get(),
    LodShops.EMPTY_SHOP.get(),
    LodShops.EMPTY_SHOP.get(),
    LodShops.EMPTY_SHOP.get(),
    LodShops.EMPTY_SHOP.get(),
    LodShops.EMPTY_SHOP.get(),
