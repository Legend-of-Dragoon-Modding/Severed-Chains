...
public class SMap extends EngineState {
  ...
  public static final RegistryDelegate<ShopStruct40>[] shops_800f4930 = new RegistryDelegate[] {
    LodShops.BALE_EQUIPMENT_SHOP,
    LodShops.SERDIO_ITEM_SHOP,
    LodShops.LOHAN_EQUIPMENT_SHOP,
    LodShops.LOHAN_ITEM_SHOP,
    LodShops.KAZAS_EQUIPMENT_SHOP,
    LodShops.KAZAS_FORT_ITEM_SHOP,
    LodShops.FLETZ_EQUIPMENT_SHOP,
    LodShops.FLETZ_ITEM_SHOP,
    LodShops.DONAU_EQUIPMENT_SHOP,
    LodShops.DONAU_ITEM_SHOP,
    LodShops.QUEEN_FURY_EQUIPMENT_SHOP,
    LodShops.QUEEN_FURY_ITEM_SHOP,
    LodShops.FUENO_EQUIPMENT_SHOP,
    LodShops.FUENO_ITEM_SHOP,
    LodShops.FURNI_EQUIPMENT_SHOP,
    LodShops.FURNI_ITEM_SHOP,
    LodShops.DENINGRAD_EQUIPMENT_SHOP,
    LodShops.DENINGRAD_ITEM_SHOP,
    LodShops.WINGLY_FOREST_EQUIPMENT_SHOP,
    LodShops.WINGLY_FOREST_ITEM_SHOP,
    LodShops.VELLWEB_EQUIPMENT_SHOP,
    LodShops.VELLWEB_ITEM_SHOP,
    LodShops.ULARA_EQUIPMENT_SHOP,
    LodShops.ULARA_ITEM_SHOP,
    LodShops.ROUGE_EQUIPMENT_SHOP,
    LodShops.ROUGE_ITEM_SHOP,
    LodShops.MOON_EQUIPMENT_SHOP,
    LodShops.MOON_ITEM_SHOP,
    LodShops.HELLENA_01_ITEM_SHOP,
    LodShops.KASHUA_EQUIPMENT_SHOP,
    LodShops.KASHUA_ITEM_SHOP,
    LodShops.FLETZ_ACCESSORY_SHOP,
    LodShops.FOREST_ITEM_SHOP,
    LodShops.KAZAS_FORT_EQUIPMENT_SHOP,
    LodShops.VOLCANO_ITEM_SHOP,
    LodShops.ZENEBATOS_EQUIPMENT_SHOP,
    LodShops.ZENEBATOS_ITEM_SHOP,
    LodShops.HELLENA_02_ITEM_SHOP,
    LodShops.UNKNOWN_SHOP_01,
    LodShops.EMPTY_SHOP,
    LodShops.EMPTY_SHOP,
    LodShops.EMPTY_SHOP,
    LodShops.EMPTY_SHOP,
