...
public class SMap extends EngineState {
  ...
  private final UvAdjustmentMetrics14[] uvAdjustments_800f5930 = {
    ...
    new UvAdjustmentMetrics14(0x1c000000,  0x3c0ffff,      0x0, 0xffe0ffff,    0x0), // Dart
	  ...
	  new UvAdjustmentMetrics14(0x7c040000,  0x3c0ffff, 0x110000, 0xffe0ffff, 0x8000), // Albert
	  ...
	  new UvAdjustmentMetrics14(0x1c000000,  0x3c0ffff,      0x0, 0xffe0ffff,    0x0), // 2 Dart 2 Furious
	  new UvAdjustmentMetrics14(0x1c070000,  0x3c0ffff, 0x010000, 0xffe0ffff, 0x00c0), // Lavitz
	  new UvAdjustmentMetrics14(0x1c0b0000,  0x3c0ffff, 0x020000, 0xffe0ffff, 0x00c0), // Lloyd
    ...
    switch(this.mediaLoadingStage_800c68e4) {
      ...
      case LOAD_SOBJS_6 -> {
        if(this.submapAssetsLoaded_800c6874 && this.submapScriptsLoaded_800c68d0) {
          ...
          final int[] files = {102, 136, 374, 408, 409, 442, 443, 444};
