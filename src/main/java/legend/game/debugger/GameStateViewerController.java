    ...
    this.updateUI.scheduleAtFixedRate(new TimerTask() {
      ...
      public void run() {
        Platform.runLater(() -> {
          ...
          GameStateViewerController.this.dataIII0.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(0)));
          GameStateViewerController.this.dataIII1.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(1)));
          GameStateViewerController.this.dataIII2.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(2)));
          GameStateViewerController.this.dataIII3.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(3)));
          GameStateViewerController.this.dataIII4.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(4)));
          GameStateViewerController.this.dataIII5.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(5)));
          GameStateViewerController.this.dataIII6.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(6)));
          GameStateViewerController.this.dataIII7.setText(String.valueOf(gameState_800babc8.visitedLocations_17c.getRaw(7)));
