...
public class CombatDebuggerController {
  ...
  public void initialize() {
    ...
    this.hp.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(0, 2147483647));
    this.maxHp.setValueFactory(new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 2147483647));
