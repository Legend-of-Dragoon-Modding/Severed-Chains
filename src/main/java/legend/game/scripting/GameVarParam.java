...
public class GameVarParam extends Param {
  ...
  public int get() {
    return switch(this.index) {
      ...
      case 33 -> Bttl_800c.allBentCount_800c66d0.get();
...
//      case 137 -> Scus94491BpeSegment_8006._8006e398.specialEffect_00[9]._00.get();
  ...
  public Param set(final int val) {
    switch(this.index) {
      ...
      case 33 -> Bttl_800c.allBentCount_800c66d0.set(val);
...
//      case 75 -> Scus94491BpeSegment_8004._8004de50;
      ...
      case 80 -> Bttl_800c.scriptState_800c6914 = (ScriptState<BattleEntity27c>)scriptStatePtrArr_800bc1c0[val];
