...
public class GameVarParam extends Param {
  ...
  public int get() {
    return switch(this.index) {
      ...
      case 32 -> Scus94491BpeSegment_8006.battleState_8006e398.allBents_e0c[0] != null ? Scus94491BpeSegment_8006.battleState_8006e398.allBents_e0c[0].index : -1;
      case 33 -> Battle.allBentCount_800c66d0.get();
      case 34 -> Scus94491BpeSegment_8006.battleState_8006e398.charBents_e40[0] != null ? Scus94491BpeSegment_8006.battleState_8006e398.charBents_e40[0].index : -1;
      case 35 -> Battle.charCount_800c677c.get();
      case 36 -> Scus94491BpeSegment_8006.battleState_8006e398.monsterBents_e50[0] != null ? Scus94491BpeSegment_8006.battleState_8006e398.monsterBents_e50[0].index : -1;
      case 37 -> Battle.monsterCount_800c6768.get();
      ...
      case 42 -> Battle.forcedTurnBent_800c66bc != null ? Battle.forcedTurnBent_800c66bc.index : -1;
      case 43 -> Scus94491BpeSegment_800b.encounterId_800bb0f8;
      case 44 -> Battle._800c6748.get();
...
//      case 46 -> Bttl_800c.intRef_800c6718.get();
      ...
      case 49 -> Battle.aliveBentCount_800c669c.get();
      ...
      case 51 -> Battle.aliveCharCount_800c6760.get();
      case 52 -> Scus94491BpeSegment_8006.battleState_8006e398.aliveMonsterBents_ebc[0] != null ? Scus94491BpeSegment_8006.battleState_8006e398.aliveMonsterBents_ebc[0].index : -1;
      case 53 -> Battle.aliveMonsterCount_800c6758.get();
      ...
      case 59 -> Battle.currentTurnBent_800c66c8 != null ? Battle.currentTurnBent_800c66c8.index : -1;
      ...
      case 68 -> Scus94491BpeSegment_800b._800bda08;
...
//      case 75 -> Scus94491BpeSegment_8004._8004de50;
      ...
      case 80 -> Battle.scriptState_800c6914 != null ? Battle.scriptState_800c6914.index : -1;
      case 81 -> Battle._800c6918.get();
      case 82 -> Battle._800c67c8.get();
      case 83 -> Battle._800c67cc.get();
      case 84 -> Battle._800c67d0.get();
      case 85 -> Battle._800c6710.get();
      case 86 -> Battle.currentCameraIndex_800c6780.get();
      case 87 -> Battle._800c66a8.get();
      case 88 -> Battle._800c6700.get();
      case 89 -> Battle._800c6704.get();
      case 90 -> Battle.currentCameraPositionIndicesIndex_800c66b0.get();

      case 96 -> Battle._800c6754.get();
      case 97 -> Battle.currentStage_800c66a4.get();

      case 104 -> Battle.shouldRenderMcq_800c6764.get();
      case 105 -> Battle.mcqOffsetX_800c6774.get();
      case 106 -> Battle.mcqOffsetY_800c6778.get();
      case 107 -> Battle.mcqStepX_800c676c.get();
      case 108 -> Battle.mcqStepY_800c6770.get();
      case 109 -> Battle.mcqColour_800fa6dc.get();
...
//      case 137 -> Scus94491BpeSegment_8006._8006e398.specialEffect_00[9]._00.get();
  ...
  public Param set(final int val) {
    switch(this.index) {
      ...
      case 32 -> Scus94491BpeSegment_8006.battleState_8006e398.allBents_e0c[0] = (ScriptState<BattleEntity27c>)scriptStatePtrArr_800bc1c0[val];
      case 33 -> Battle.allBentCount_800c66d0.set(val);
      case 34 -> Scus94491BpeSegment_8006.battleState_8006e398.charBents_e40[0] = (ScriptState<PlayerBattleEntity>)scriptStatePtrArr_800bc1c0[val];
      case 35 -> Battle.charCount_800c677c.set(val);
      case 36 -> Scus94491BpeSegment_8006.battleState_8006e398.monsterBents_e50[0] = (ScriptState<MonsterBattleEntity>)scriptStatePtrArr_800bc1c0[val];
      case 37 -> Battle.monsterCount_800c6768.set(val);
      ...
      case 42 -> Battle.forcedTurnBent_800c66bc = (ScriptState<BattleEntity27c>)scriptStatePtrArr_800bc1c0[val];
      case 43 -> Scus94491BpeSegment_800b.encounterId_800bb0f8 = val;
      case 44 -> Battle._800c6748.set(val);
//      case 45 -> Scus94491BpeSegment_8006._8006e398._180.get(0);
//      case 46 -> Bttl_800c.intRef_800c6718.set(val);
      ...
      case 49 -> Battle.aliveBentCount_800c669c.set(val);
      ...
      case 51 -> Battle.aliveCharCount_800c6760.set(val);
      ...
      case 53 -> Battle.aliveMonsterCount_800c6758.set(val);
      ...
      case 59 -> Battle.currentTurnBent_800c66c8 = (ScriptState<BattleEntity27c>)scriptStatePtrArr_800bc1c0[val];
      ...
      case 68 -> Scus94491BpeSegment_800b._800bda08 = val;
...
//      case 75 -> Scus94491BpeSegment_8004._8004de50;
      ...
      case 80 -> Battle.scriptState_800c6914 = (ScriptState<BattleEntity27c>)scriptStatePtrArr_800bc1c0[val];
      case 81 -> Battle._800c6918.set(val);
      case 82 -> Battle._800c67c8.set(val);
      case 83 -> Battle._800c67cc.set(val);
      case 84 -> Battle._800c67d0.set(val);
      case 85 -> Battle._800c6710.set(val);
      case 86 -> Battle.currentCameraIndex_800c6780.set(val);
      case 87 -> Battle._800c66a8.set(val);
      case 88 -> Battle._800c6700.set(val);
      case 89 -> Battle._800c6704.set(val);
      case 90 -> Battle.currentCameraPositionIndicesIndex_800c66b0.set(val);

      case 96 -> Battle._800c6754.set(val);
      case 97 -> Battle.currentStage_800c66a4.set(val);

      case 104 -> Battle.shouldRenderMcq_800c6764.set(val);
      case 105 -> Battle.mcqOffsetX_800c6774.set(val);
      case 106 -> Battle.mcqOffsetY_800c6778.set(val);
      case 107 -> Battle.mcqStepX_800c676c.set(val);
      case 108 -> Battle.mcqStepY_800c6770.set(val);
      case 109 -> Battle.mcqColour_800fa6dc.set(val);
