...
public class PostBattleScreen extends MenuScreen {
  ...
  private void levelUpDragoon(final int charIndex, final int charSlot) {
    if(charIndex != -1) {
      ...
      if(gameState_800babc8.charData_32c[charIndex].dlevelXp_0e > CoreMod.MAX_DRAGOON_EXP) {
        gameState_800babc8.charData_32c[charIndex].dlevelXp_0e = CoreMod.MAX_DRAGOON_EXP;
      }
