...
public class Item extends RegistryEntry implements InventoryEntry {
  ...
  public static Item fromFile(final String name, final String description, final String combatDescription, final int price, final FileData data) {
