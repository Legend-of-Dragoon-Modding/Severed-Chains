...
public final class V3Serializer {
  ...
  public static SavedGame fromV3(final Campaign campaign, final String filename, final FileData data) {
    final IntRef offset = new IntRef();
    final String name = data.readAscii(offset);

    final ConfigCollection config = new ConfigCollection();
    final RetailSavedGame savedGame = new RetailSavedGame(campaign, "V3", filename, name, LodMod.RETAIL_CAMPAIGN_TYPE.getId(), config);
