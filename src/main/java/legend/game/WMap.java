...
public class WMap {
  ...
  public static void FUN_800ccecc() {
    FUN_800cd278();
    pregameLoadingStage_800bb10c.setu(0xbL);
  }
  ...
  public static WMapRender40 FUN_800cd3c8(final long a0, final COLOUR a1, final COLOUR a2, final COLOUR a3, final COLOUR a4, final long a5, final long a6, final long a7, final long a8, final long a9, final boolean transparency, final TexPageTrans transparencyMode, final long a12, final long a13, final long a14, final long a15, final long a16) {
    ...
    //LAB_800cd600
    sp34._1c.set(MEMORY.ref(4, mallocTail(sp34._30.get() * 0x8L), UnboundedArrayRef.of(0x8, WMapRender08_2::new)));
  ...
  public static void FUN_800ce4dc(final WMapRender40 a0) {
    ...
    if(a0._3d.get() == 0x9L) {
      ...
      for(int i = 0; i < a0._30.get(); i++) {
        ...
        queueGpuPacket(tags_1f8003d0.deref().get(a0._3e.get()).getAddress(), sp18);

        if(a0.transparency_3c.get()) {
          queueGpuPacket(tags_1f8003d0.deref().get(a0._3e.get()).getAddress(), sp14);
        }
      ...
      for(int i = 0; i < a0._30.get(); i++) {
        ...
        MEMORY.ref(2, sp18).offset(0x20L).setu(sp20._00.get() + a0._38.get() + sp20._04.get());
        MEMORY.ref(2, sp18).offset(0x22L).setu(sp20._02.get() + a0._3a.get() + sp20._06.get());
        queueGpuPacket(tags_1f8003d0.deref().get(a0._3e.get()).getAddress(), sp1c.getAddress());
      }
  ...
  public static void FUN_800d4058() {
    ...
    if(v0 == 0x1L) {
      ...
      //LAB_800d4170
      if((joypadPress_8007a398.get() & 0x1) != 0) {
        FUN_8002a3ec(7, 0);
      }
      ...
      if((joypadPress_8007a398.get() & 0x2) != 0) {
        _800c86f0.setu(0);
      }
    ...
    perspectiveTransform(sp0x58, sp0x60, sp0x68, sp0x64);
    sp70 = sp0x60.getXY();
    sp72 = sp0x60.getY();
    sp74 = gpuPacketAddr_1f8003d8.get();
    gpuPacketAddr_1f8003d8.addu(0x14L);
    sp30 = sp74;
    setGpuPacketType(0xeL, sp30, false, false);
    sp78 = gpuPacketAddr_1f8003d8.get();
    gpuPacketAddr_1f8003d8.setu(sp78 + 0x8L);
    sp34 = sp78;
    MEMORY.ref(2, sp30).offset(0xeL).setu(0x7c28L);
    MEMORY.ref(1, sp34).offset(0x3L).setu(1);
    MEMORY.ref(4, sp34).offset(0x4L).setu(0xe100_000aL | texPages_800bb110.get(TexPageBpp.BITS_4).get(TexPageTrans.B_PLUS_F).get(TexPageY.Y_256).get() & 0x9ff);
    MEMORY.ref(1, sp30).offset(0x4L).setu(0x55L);
    MEMORY.ref(1, sp30).offset(0x5L).setu(0);
    MEMORY.ref(1, sp30).offset(0x6L).setu(0);
    MEMORY.ref(2, sp30).offset(0x8L).setu(sp70 - sp1c / 2);
    MEMORY.ref(2, sp30).offset(0xaL).setu(sp72 - sp1c);
    MEMORY.ref(2, sp30).offset(0x10L).setu(sp1c);
    MEMORY.ref(2, sp30).offset(0x12L).setu(sp1c);
    a0 = _800bb0fc.get() & 0x7L;
    MEMORY.ref(1, sp30).offset(0xcL).setu(a0 * sp1c);
    MEMORY.ref(1, sp30).offset(0xdL).setu(sp18);
    queueGpuPacket(tags_1f8003d0.deref().get(25).getAddress(), sp30);
    queueGpuPacket(tags_1f8003d0.deref().get(25).getAddress(), sp34);
    v0 = 0x800c_0000L;
...
//    FUN_800e774c(_800f0234.offset(v0).deref(4).cast(ArrayRef.of(UnsignedShortRef.class, 0xff, 2, UnsignedShortRef::new)), v1, (short)a0, 0, 0); //TODO
  ...
  public static void FUN_800d6900() {
    ...
    //LAB_800d6950
    final long sp10 = gpuPacketAddr_1f8003d8.get();
    gpuPacketAddr_1f8003d8.addu(0x14L);

    setGpuPacketType(0xeL, sp10, false, false);

    final long sp14 = gpuPacketAddr_1f8003d8.get();
    ...
    queueGpuPacket(tags_1f8003d0.getPointer() + 0x34L, sp10);
    queueGpuPacket(tags_1f8003d0.getPointer() + 0x34L, sp14);
    ...
    for(int i = 0; i < 7; i++) {
      //LAB_800d6c30
      sp0x20[i] = gpuPacketAddr_1f8003d8.get();
      gpuPacketAddr_1f8003d8.addu(0x14L);

      sp0x40[i] = gpuPacketAddr_1f8003d8.get();
      gpuPacketAddr_1f8003d8.addu(0x8L);
      ...
      queueGpuPacket(tags_1f8003d0.getPointer() + 0x50L, sp0x20[i]);
      queueGpuPacket(tags_1f8003d0.getPointer() + 0x50L, sp0x40[i]);
    }
  ...
  public static void FUN_800d7208(final long a0) {
    ...
    queueGpuPacket(tags_1f8003d0.getPointer() + 0x34L, packet);
    ...
    if(a0 == 0) {
      ...
      sp28 = gpuPacketAddr_1f8003d8.get();
      gpuPacketAddr_1f8003d8.addu(0x28L);
      ...
      queueGpuPacket(tags_1f8003d0.getPointer() + 0x34L, sp28);
    } else {
      //LAB_800d7734
  ...
  public static void renderPath() {
    ...
    sp10 = gpuPacketAddr_1f8003d8.get();
  ...
  public static void FUN_800da248() {
    ...
    switch(struct258_800c66a8.deref()._220.get()) {
      case 1:
        ...
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2Param_64.rotate.setX((short)0);
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2Param_64.rotate.setY(struct258_800c66a8.deref().rotation_a4.getY());
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2Param_64.rotate.setZ((short)0);
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setX(0x400);
        ...
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2_14.coord.transfer.setX(struct258_800c66a8.deref().coord2_34.coord.transfer.getX());
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2_14.coord.transfer.setY(struct258_800c66a8.deref().coord2_34.coord.transfer.getY());
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2_14.coord.transfer.setZ(struct258_800c66a8.deref().coord2_34.coord.transfer.getZ());
      ...
      case 2:
        ...
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.y.add(0x40);

        if(struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.getX() > 0x600L) {
          struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setX(0x600);
        }

        //LAB_800da9fc
        a0 = struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.getX();
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setY((int)a0);
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setZ((int)a0);
      ...
      case 3:
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.set(0, 0, 0);
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2Param_64.rotate.setX((short)0x400);
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2Param_64.rotate.setY((short)0x800);
        struct258_800c66a8.deref().models_0c.get(2).deref().coord2Param_64.rotate.setZ((short)0);
      ...
      case 4:
        ...
        //LAB_800db07c
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.x.add(0x200);

        if(struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.getX() > 0x800) {
          struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setX(0x800);
        }
      ...
      case 5:
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.set(0x800, 0x800, 0x800);
      ...
      case 7:
        ...
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.x.sub(170);

        if(struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.getX() < 0) {
          struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setX(0);
        }
      ...
      case 0xd:
        ...
        //LAB_800dbeb4
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.x.sub(16);

        if(struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.getX() < 1024) {
          struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setZ(1024);
        }

        //LAB_800dbf28
        final int x = struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.getX();
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setY(x);
        struct258_800c66a8.deref().models_0c.get(2).deref().scaleVector_fc.setZ(x);
  ...
  public static void FUN_800dfbd8() {
    ...
    for(int i = 0; i < 4; i++) {
      ...
      model.coord2_14.coord.transfer.setY(struct258.coord2_34.coord.transfer.getY());
      model.coord2_14.coord.transfer.setZ(struct258.coord2_34.coord.transfer.getZ());
      model.coord2Param_64.rotate.setX((short)0);
      model.coord2Param_64.rotate.setY(struct258.rotation_a4.getY());
      model.coord2Param_64.rotate.setZ((short)0);
      model.scaleVector_fc.setX(0);
      model.scaleVector_fc.setY(0);
      model.scaleVector_fc.setZ(0);
    }
  ...
  public static void FUN_800e0274() {
    ...
    //LAB_800e04fc
    struct.models_0c.get(struct.modelIndex_1e4.get()).deref().zOffset_a0.set((short)0x4e);
  ...
  public static void FUN_800e78c0() {
    ...
    //LAB_800e7cbc
    int sp24;
    for(sp24 = 0; _800f0e34.get(sp24).areaIndex_00.get() != -0x2L; sp24++) {
      // intentionally empty
    }
    ...
    if(sp2c == 0 && _800bdc34.get() == 0 || _80052c6c.get() != 0) {
      ...
      for(int i = 0; i < _800c67a0.get(); i++) {
        //LAB_800e7f24
        sp24 = _800f0e34.get(i).areaIndex_00.get();

        if(sp24 != -0x1L) {
          //LAB_800e7f68
          if(FUN_800eb09c(i, -1, null) == 0) {
            //LAB_800e7f88
            if(sp24 == areaIndex_800c67aa.get()) {
              sp1c = i;
              break;
            }
          }
      ...
      if((int)sp4c > 0) {
        ...
        //LAB_800e8190
        sp50 = _800f5810.offset((Math.abs(area._00.get()) - 1) * 0x4L).get() - 0x1L;
    ...
    weightedAvg(0x4L - dotOffset_800c67b0.get(), dotOffset_800c67b0.get(), sp0x58, sp0x68, sp0x78);
  ...
  public static void FUN_800e8a90() {
    ...
    //LAB_800e8b94
    //LAB_800e8bc0
    if((int)sp4 < 0 && facing_800c67b4.get() > 0 || (int)sp4 > 0 && facing_800c67b4.get() < 0) {
      //LAB_800e8bec
      sp0 = -sp0;
    }
  ...
  public static void getPathPositions(final VECTOR playerPos, final VECTOR nextPathPos) {
    ...
    final long v0 = sp00 + dotIndex_800c67ae.get() * 0x10L;
    playerPos.set((VECTOR)MEMORY.ref(4, v0, VECTOR::new));

    final long v1 = sp00 + (dotIndex_800c67ae.get() + 1) * 0x10L;
      ...
      if(FUN_800eb09c(i, 0, null) == 0) {
        ...
        if(_800f0e34.get(i)._0c.get() != -1) {
          ...
          if(facing_800c67b4.get() <= 0 || sp50 >= 0) {
            ...
            if(facing_800c67b4.get() >= 0 || sp50 <= 0) {
              //LAB_800e9988
              final int sp58 = Math.abs(sp50) - 1;
              final long sp40 = pathPosPtrArr_800f591c.offset(sp58 * 0x4L).get();
              ...
              if(sp0x30.getX() == sp0x10.getX() && sp0x30.getY() == sp0x10.getY() && sp0x30.getZ() == sp0x10.getZ()) {
                _800c67d8.get(sp4c).set((VECTOR)MEMORY.ref(4, sp40).offset(_800f5810.offset(sp58 * 0x4L).get() * 0x10L).offset(-0x20L).cast(VECTOR::new));
                _800c6874.get(sp4c).set(sp54);
                sp4c++;
                //LAB_800e9bd8
              } else if(sp0x30.getX() == sp0x20.getX() && sp0x30.getY() == sp0x20.getY() && sp0x30.getZ() == sp0x20.getZ()) {
                _800c67d8.get(sp4c).set((VECTOR)MEMORY.ref(4, sp40 + 0x10L, VECTOR::new));
                _800c6874.get(sp4c).set(sp54);
                sp4c++;
              }
            }
  ...
  public static void updatePlayer() {
    ...
    weightedAvg(0x4L - dotOffset_800c67b0.get(), dotOffset_800c67b0.get(), struct258_800c66a8.deref().vec_94, playerPos, nextDotPos);
  ...
  public static void FUN_800ea630(final int a0) {
    ...
    if(sign > 0) {
      ...
      //LAB_800ea8d4
      final int v1 = area._00.get();

      final int sp10 = (int)_800f5810.offset((Math.abs(v1) - 1) * 0x4L).get() - 1;
  ...
  public static void FUN_800eab94(final int a0) {
    ...
    final long sp14 = pathPosPtrArr_800f591c.offset(pathIndex_800c67ac.get() * 0x4L).get();

    final int dx;
    final int dz;
    if(facing_800c67b4.get() > 0) {
      final long sp10 = _800f5810.offset((Math.abs(areaData._00.get()) - 1) * 0x4L).get() - 1;
      dx = (int)(MEMORY.ref(4, sp14).offset(sp10 * 0x10L).offset(0x0L).get() - MEMORY.ref(4, sp14).offset((sp10 - 1) * 0x10L).offset(0x0L).get());
      dz = (int)(MEMORY.ref(4, sp14).offset(sp10 * 0x10L).offset(0x8L).get() - MEMORY.ref(4, sp14).offset((sp10 - 1) * 0x10L).offset(0x8L).get());
      struct258.coord2_34.coord.transfer.set(
        (int)MEMORY.ref(4, sp14).offset(sp10 * 0x10L).offset(0x0L).get(),
        (int)MEMORY.ref(4, sp14).offset(sp10 * 0x10L).offset(0x4L).get() - 2,
        (int)MEMORY.ref(4, sp14).offset(sp10 * 0x10L).offset(0x8L).get()
      );
      dotIndex_800c67ae.set((short)(sp10 - 1));
      dotOffset_800c67b0.set((short)3);
      _800c6858.setu(0);
      ...
      //LAB_800eaf14
      struct258.coord2_34.coord.transfer.set(
        (int)MEMORY.ref(4, sp14).offset(0x0L).get(),
        (int)MEMORY.ref(4, sp14).offset(0x4L).get() - 2,
        (int)MEMORY.ref(4, sp14).offset(0x8L).get()
      );
      dx = (int)(MEMORY.ref(4, sp14).offset(0x0L).get() - MEMORY.ref(4, sp14).offset(0x10L).offset(0x0L).get());
      dz = (int)(MEMORY.ref(4, sp14).offset(0x8L).get() - MEMORY.ref(4, sp14).offset(0x10L).offset(0x8L).get());
      dotIndex_800c67ae.set((short)0);
      dotOffset_800c67b0.set((short)0);
    ...
    previousPlayerRotation_800c685a.setu(struct258.rotation_a4.getY());
    _800c6894.setu(0);
  ...
  public static void FUN_800ecd10() {
    ...
    for(int i = 0; i < 64; i++) {
      ...
      MEMORY.ref(1, packet).offset(0xcL).setu(MEMORY.ref(1, at).offset(0x65c8L).get());
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2 + 0x1L;
      MEMORY.ref(1, packet).offset(0xdL).setu(MEMORY.ref(1, at).offset(0x65c8L).get());
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2;
      MEMORY.ref(1, packet).offset(0x14L).setu(MEMORY.ref(1, at).offset(0x65c8L).get() + 0x8L);
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2;
      MEMORY.ref(1, packet).offset(0x15L).setu(MEMORY.ref(1, at).offset(0x65c8L).get());
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2;
      MEMORY.ref(1, packet).offset(0x1cL).setu(MEMORY.ref(1, at).offset(0x65c8L).get());
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2 + 0x1L;
      MEMORY.ref(1, packet).offset(0x1dL).setu(MEMORY.ref(1, at).offset(0x65c8L).get() + 0x8L);
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2;
      MEMORY.ref(1, packet).offset(0x24L).setu(MEMORY.ref(1, at).offset(0x65c8L).get() + 0x8L);
      at = 0x800f_0000L;
      at = at + sp38.rotation_50.getZ() / 2 * 2 + 0x1L;
      MEMORY.ref(1, packet).offset(0x25L).setu(MEMORY.ref(1, at).offset(0x65c8L).get() + 0x8L);
  ...
  public static void FUN_800edbc0() {
    ...
    //LAB_800edc84
    long packetAddr = gpuPacketAddr_1f8003d8.get();
                          ...
                          if(MEMORY.ref(2, packetAddr).offset(0x20L).getSigned() - MEMORY.ref(2, packetAddr).offset(0x18L).getSigned() < 0x401L) {
                            ...
                            if(MEMORY.ref(2, packetAddr).offset(0x22L).getSigned() - MEMORY.ref(2, packetAddr).offset(0x12L).getSigned() < 0x201L) {
                              ...
                              if((int)sp84 >= 0x6L && (int)sp84 < (int)(orderingTableSize_1f8003c8.get() - 0x1L)) {
                                ...
                                queueGpuPacket(tags_1f8003d0.getPointer() + 0x190L + sp84 * 0x4L, packetAddr);
    ...
    //LAB_800eed1c
    gpuPacketAddr_1f8003d8.setu(packetAddr);
