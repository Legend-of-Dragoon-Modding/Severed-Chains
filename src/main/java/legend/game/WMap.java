...
public class WMap {
  ...
  private static final VECTOR _800c67b8 = MEMORY.ref(4, 0x800c67b8L, VECTOR::new);
  private static final VECTOR _800c67c8 = MEMORY.ref(4, 0x800c67c8L, VECTOR::new);
  ...
  private static final ArrayRef<UnsignedShortRef> _800effa4 = MEMORY.ref(4, 0x800effa4L, ArrayRef.of(UnsignedShortRef.class, 0xff, 2, UnsignedShortRef::new));
  private static final ArrayRef<UnsignedShortRef> _800effb0 = MEMORY.ref(4, 0x800effb0L, ArrayRef.of(UnsignedShortRef.class, 0xff, 2, UnsignedShortRef::new));
  private static final ArrayRef<UnsignedShortRef> _800f00e8 = MEMORY.ref(4, 0x800f00e8L, ArrayRef.of(UnsignedShortRef.class, 0xff, 2, UnsignedShortRef::new));
...
//        primitives += primitiveCount * 0x2cL;
  ...
  public static void FUN_800d1db8() {
    ...
    for(int i = 0; i < _800c67a0.get(); i++) {
      //LAB_800d1e38
      if(!_800f0234.get(_800f0e34.get(i)._02.get())._00.isNull()) {
        //LAB_800d1e90
  ...
  public static void FUN_800d4058() {
    ...
    FUN_800e7624(_800f0234.get((int)v0)._00.deref(), sp0x28, sp0x2c);
    v0 = 0x800d_0000L;
...
//    FUN_800e774c(_800f0234.offset(v0).deref(4).cast(ArrayRef.of(UnsignedShortRef.class, 0xff, 2, UnsignedShortRef::new)), v1, (short)a0, 0, 0); //TODO
  ...
  public static void FUN_800e367c(final long a0) {
    ...
    if((int)_800c6ae8.get() >= 5120) {
      ...
      _800bb0a0.setu(_800c67ac.get());
      _800bb0a2.setu(_800c67ae.get());
      _800bb0a4.setu(_800c67b0.get() & 0xff);
      _800bb0a5.setu(_800c67b4.get() & 0xff);
  ...
  public static void FUN_800e5150() {
    ...
    switch((int)_800c68a4.get()) {
      case 0:
        ...
        if(_800f0234.get(_800f0e34.get((int)_800c67a8.get())._02.get())._00.isNull()) {
          _800c68a4.setu(0x8L);
        }

        //LAB_800e54c4
        _800c6898.deref()._34.set(0);
      ...
      case 1:
        ...
        loadDrgnBinFile(0, 5655 + _800f0234.get(_800f0e34.get((int)_800c67a8.get())._02.get())._04.get(), 0, getMethodAddress(WMapStruct0c.class, "FUN_800d5768", Value.class, long.class, long.class), 0x1L, 0x4L);
      ...
      case 3:
        ...
        FUN_800e7624(_800f0234.get((int)sp30)._00.deref(), sp0x3c, sp0x38);
        FUN_800e774c(_800f0234.get((int)sp30)._00.deref(), (short)(0xf0L - sp0x3c.get() * 3), (short)(0x8cL - sp0x38.get() * 7), 0, 0);
  ...
  public static void FUN_800e69e8() {
    ...
    for(int i = 0; i < _800c86cc.get(); i++) {
      //LAB_800e6c5c
      if(!_800f0234.get(_800f0e34.get((int)_800c84c8.offset(i * 0x2L).getSigned())._02.get())._00.isNull()) {
        //LAB_800e6ccc
    ...
    for(i = 0; i < 7 && (int)_800c68b0.offset(i * 0xcL).get() >= 0; i++) {
      ...
      if(!_800f0234.get((int)sp24)._00.isNull()) {
        //LAB_800e70f4
        FUN_800e7624(_800f0234.get((int)sp24)._00.deref(), sp0x70, sp0x74);
        ...
        if(v0 == 0x1L) {
          ...
          if(sp0x70.get().intValue() >= 0x4L) {
            _800be358.get(i)._18.set(sp0x70.get().intValue());
          } else {
            _800be358.get(i)._18.set(4);
          }

          //LAB_800e7298
          _800be358.get(i)._1a.set(sp0x74.get().intValue());
          ...
          //LAB_800e735c
          _800be358.get(i)._1a.set(sp0x74.get().intValue());
          _800be358.get(i)._1c.set((short)_800be358.get(i)._18.get() * 9 / 2);
          _800be358.get(i)._1e.set((short)_800be358.get(i)._1a.get() * 6);
        ...
        FUN_800e774c(_800f0234.get((int)sp24)._00.deref(), (short)(sp6c - sp0x70.get() * 3), (short)(sp6e - sp0x74.get() * 7), 0, 0);
      }
  ...
  @Method(0x800e7624L)
  public static void FUN_800e7624(final ArrayRef<UnsignedShortRef> a0, final Ref<Long> a1, final Ref<Long> a2) {
    long sp0 = 0;
    long sp4 = 0x1L;
    long sp8 = 0;

    //LAB_800e7648
    for(int sp18 = 0; a0.get(sp18).get() != 0xa0ffL; sp18++) {
      //LAB_800e7668
      if(a0.get(sp18).get() == 0xa1ffL) {
        sp4++;
  ...
  public static void FUN_800e78c0() {
    ...
    if(sp2c == 0 && _800bdc34.get() == 0 || _80052c6c.get() != 0) {
      ...
      _800c67ac.setu(_800bb0a0.get());
      _800c67ae.setu(_800bb0a2.get());
      _800c67b0.setu(_800bb0a4.get());
      _800c67b4.setu(_800bb0a5.getSigned());
      _800c686c.setu(0);
      _800c6868.setu(0);
      ...
      //LAB_800e8068
      sp48 = _800f591c.offset(_800c67ac.get() * 0x4L).get();
      ...
      struct258_800c66a8.deref().rotation_a4.setY((short)FUN_80040b90(sp58, sp60));
      _800c685a.setu(struct258_800c66a8.deref().rotation_a4.getY());
    ...
    weightedAvg(0x4L - _800c67b0.getSigned(), _800c67b0.getSigned(), sp0x58, sp0x68, sp0x78);
  ...
  public static void FUN_800e8cb0() {
    ...
    if(_800c67b0.getSigned() >= 0x4L) {
      ...
      //LAB_800e8dfc
      //LAB_800e8e04
    } else if(_800c67b0.getSigned() < 0) {
      _800c67ae.subu(0x1L);
      _800c67b0.addu(0x4L);

      if(_800c67ae.getSigned() < 0) {
        _800c67ae.setu(0);
        _800c67b0.setu(0);
        _800c6890.setu(0x1L);
      }
  ...
  public static void FUN_800e9104() {
    ...
    //LAB_800e91cc
    sp0 = (_800c66b0.deref().rotation_70.getY() - _800c685a.get() - 0x700L) & 0xfffL;
  ...
  public static void FUN_800e9648() {
    ...
    struct258_800c66a8.deref().rotation_a4.setY((short)FUN_80040b90(_800c67b8.getX() - _800c67c8.getX(), _800c67b8.getZ() - _800c67c8.getZ()));
    ...
    for(int i = 0; i < _800c67a0.get(); i++) {
      ...
      if(FUN_800eb09c(i, 0, null) == 0) {
        ...
        if(_800f0e34.get(i)._06.get() != -0x1L) {
          ...
          if((int)_800c67b4.get() <= 0 || (int)sp50 >= 0) {
            //LAB_800e995c
            if((int)_800c67b4.get() >= 0 || (int)sp50 <= 0) {
              //LAB_800e9988
              sp58 = Math.abs(sp50) - 0x1L;
              sp40 = _800f591c.offset(sp58 * 0x4L).get();
  ...
  public static void FUN_800e9d68() {
    ...
    for(int i = 0; i < 7; i++) {
      ...
      sp0xc8[i] = (short)((_800c66b0.deref().rotation_70.getY() - FUN_80040b90(sp0xb0.getX(), sp0xb0.getZ()) + 0x800) & 0xfff);
    ...
    //LAB_800ea1dc
    final long spc0 = _800f591c.offset(_800c67ac.get() * 0x4L).get();
    ...
    if(_800c6848.getX() != sp0xb0.getX() || _800c6848.getY() != sp0xb0.getY() || _800c6848.getZ() != sp0xb0.getZ()) {
      //LAB_800ea2f8
      if((int)sp20 > 0) {
        _800c67ae.setu(_800f5810.offset((Math.abs(_800f2248.offset(_800c67aa.get() * 0x8L).getSigned()) - 0x1L) * 0x4L).get() - 0x2L);
        _800c67b0.setu(0x2L);
        _800c67b4.setu(-0x1L);
        _800c6858.setu(0x800L);
      } else {
  ...
  public static void FUN_800ea3d8() {
    ...
    weightedAvg(0x4L - _800c67b0.getSigned(), _800c67b0.getSigned(), struct258_800c66a8.deref().vec_94, sp0x18, sp0x28);
    struct258_800c66a8.deref().vec_94.y.sub(0x2000);
    _800c67b8.set(sp0x18);
    _800c67c8.set(sp0x28);
  ...
  public static void FUN_800ea630(final int a0) {
    ...
    //LAB_800ea790
    final long sp18 = _800f591c.offset(_800c67ac.get() * 0x4L).get();
    ...
    struct258_800c66a8.deref().rotation_a4.setY((short)FUN_80040b90(sp20, sp28));
          ...
          for(int sp1c = i; sp1c < _800c67a0.get(); sp1c++) {
            ...
            if(FUN_800eb09c(sp1c, 0, null) == 0) {
              ...
              if(sp0xd0[sp1c] == 0) {
                ...
                if(!_800f0234.get((int)sp28)._00.isNull() || !_800f0234.get((int)sp2c)._00.isNull()) {
                  // Added this check since these pointers can be null
                  if(!_800f0234.get((int)sp28)._00.isNull() && !_800f0234.get((int)sp2c)._00.isNull()) {
                    //LAB_800eb5d8
                    if(strcmp(MEMORY.ref(1, _800f0234.get((int)sp28)._00.getPointer()).getString(), MEMORY.ref(1, _800f0234.get((int)sp2c)._00.getPointer()).getString()) == 0) {
