...
public class WMap {
        ...
        if(struct._c4 == 0) {
          if(_800c6798.get() != 0x7L) {
            ...
            if(mapRotating == 0) {
              ...
              //LAB_800d310c
              if(Input.pressedThisFrame(InputKeyCode.BUTTON_SHOULDER_LEFT_1)) { // L1
                startMapRotation(-1);
                struct.mapRotating_80 = 1;
              }
        ...
        if(_800c6894.get() != 0x1L) {
          if(_800c66b0.mapRotating_80 == 0) {
            if(struct258_800c66a8._05 == 0) {
              if(_800c66b0._110 == 0) {
                if(Input.pressedThisFrame(InputKeyCode.BUTTON_SHOULDER_RIGHT_2)) { // R2
                  if(struct258_800c66a8.zoomState_1f8 == 0) {
                ...
                //LAB_800d37bc
                if(Input.pressedThisFrame(InputKeyCode.BUTTON_SHOULDER_LEFT_2)) { // L2
  ...
  public static void renderAndHandleWorldMap() {
    ...
    switch(struct258_800c66a8.zoomState_1f8) {
      case 1, 6:
        if(Input.pressedThisFrame(InputKeyCode.BUTTON_SHOULDER_RIGHT_2)) { // Zoom out
          playSound(0, 4, 0, 0, (short)0, (short)0);
      ...
      case 4:
        if(Input.pressedThisFrame(InputKeyCode.BUTTON_SHOULDER_RIGHT_2)) { // Can't zoom out more
        ...
        //LAB_800d98a8
        if(Input.pressedThisFrame(InputKeyCode.BUTTON_SHOULDER_LEFT_2)) { // Zoom in
          playSound(0, 4, 0, 0, (short)0, (short)0);
          FUN_800d9d24(-1);
          ...
          //LAB_800d9a70
          if(Input.getButtonState(InputKeyCode.BUTTON_CENTER_2)) {
            //LAB_800d9a8c
            for(int i = 0; i < 8; i++) {
              //LAB_800d9aa8
  ...
  public static void FUN_800da248() {
    ...
    if(Input.pressedThisFrame(InputKeyCode.BUTTON_WEST)) { // Square
      struct258._250 = 2;
    }
  ...
  public static void renderCoolonMap(final long a0, final long a1) {
    ...
    if(a0 != 0) {
      if(Input.pressedThisFrame(InputKeyCode.DPAD_RIGHT) || Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_RIGHT)
        || Input.pressedThisFrame(InputKeyCode.DPAD_DOWN) || Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_DOWN)) {
        playSound(0, 1, 0, 0, (short)0, (short)0);
      ...
      if(Input.pressedThisFrame(InputKeyCode.DPAD_LEFT) || Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_LEFT)
        || Input.pressedThisFrame(InputKeyCode.DPAD_UP) || Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_UP)) {
        playSound(0, 1, 0, 0, (short)0, (short)0);
  ...
  public static void FUN_800e10a0() {
    ...
    if(struct.vec_84.getX() != struct.vec_94.getX() || struct.vec_84.getY() != struct.vec_94.getY() || struct.vec_84.getZ() != struct.vec_94.getZ()) {
      //LAB_800e117c
      //LAB_800e11b0
      if(Input.getButtonState(InputKeyCode.BUTTON_EAST)) { // World Map Running
        //LAB_800e11d0
    ...
    switch((int)_800c68a4.get()) {
      ...
      case 3: // Trying to enter an area
        ...
        if(_800c6860.get() == 999L) { // Going to a different region
          ...
          //LAB_800e5970
          if(Input.pressedThisFrame(InputKeyCode.DPAD_DOWN) || Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_DOWN)) {
            _800c86d2.addu(0x1L);
          ...
          if(Input.pressedThisFrame(InputKeyCode.DPAD_UP) || Input.pressedThisFrame(InputKeyCode.DPAD_DOWN) ||
            Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_UP) || Input.pressedThisFrame(InputKeyCode.JOYSTICK_LEFT_BUTTON_DOWN)) {
            _800c86d2.xoru(0x1L);
        ...
        if((filesLoadedFlags_800c66b8.get() & 0x800L) != 0) {
          ...
          if(Input.pressedThisFrame(InputKeyCode.BUTTON_WEST) && _800c6860.get() != 999) { // Square
            playSound(0, 2, 0, 0, (short)0, (short)0);
          }

          //LAB_800e60d0
          if(Input.getButtonState(InputKeyCode.BUTTON_WEST) && _800c6860.get() != 999) { // Square
  ...
  public static void FUN_800e69e8() {
    ...
    if(_800c68a8.get() == 0) {
      ...
      //LAB_800e6b04
      if(Input.releasedThisFrame(InputKeyCode.BUTTON_CENTER_2)) {
        //LAB_800e6b20
        for(int i = 0; i < 7; i++) {
          //LAB_800e6b3c
          FUN_8002a3ec(i, 0);
  ...
  public static void processInput() {
    ...
    //LAB_800e9330
    //LAB_800e9364
    if(Input.getButtonState(InputKeyCode.BUTTON_EAST)) {
      //LAB_800e9384
      sp4 *= 2; // Running
    }
