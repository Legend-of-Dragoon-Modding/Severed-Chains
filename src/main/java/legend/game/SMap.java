...
public final class SMap {
    ...
    while(a2 != 0) {
      ...
      if((int)CPU.CFC2(31) >= 0) { // Flags
        ...
        if(CPU.MFC2(24) != 0) { // MAC0
          MEMORY.ref(1, a3).offset(-0x27L).setu(0xcL); // 12 words
          MEMORY.ref(4, a3 - 0x26L).setu(0x3e80_8080L); // Shaded textured four-point polygon, semi-transparent, tex-blend
          MEMORY.ref(4, t2).offset(0x08L).setu(CPU.MFC2(12)); // SXY0
          MEMORY.ref(4, t2).offset(0x14L).setu(CPU.MFC2(13)); // SXY1
          MEMORY.ref(4, t2).offset(0x20L).setu(CPU.MFC2(14)); // SXY2
          ...
          if(CPU.CFC2(31) >= 0) { // Flags
            MEMORY.ref(4, t2).offset(0x2cL).setu(CPU.MFC2(14)); // SXY2
  ...
  public static void FUN_800de004(final BigStruct bigStruct, final ExtendedTmd extendedTmd) {
    if(extendedTmd.ptr_04.get() != 0) {
      final long address = addToLinkedListTail(0x30L);
      bigStruct.addr_ui_a4.set(address);

      MEMORY.ref(4, address).setu(extendedTmd.getAddress() + extendedTmd.ptr_04.get() / 4 * 4);

      //LAB_800de05c
      for(int i = 0; i < 4; i++) {
        long v1 = MEMORY.ref(4, address).get();
        v1 += MEMORY.ref(4, v1).offset(i * 0x4L).get() / 4 * 4;
        MEMORY.ref(4, address).offset(0x20L).offset(i * 0x4L).setu(v1);

        if(MEMORY.ref(4, address).offset(0x20L).offset(i * 0x4L).get() == 0) {
          MEMORY.ref(1, address).offset(0x4L).offset(i).setu(0);
        } else {
          MEMORY.ref(2, address).offset(0x8L).offset(i * 0x2L).setu(0);
          MEMORY.ref(2, address).offset(0x18L).offset(i * 0x2L).setu(MEMORY.ref(4, address).offset(0x20L).offset(i * 0x4L).deref(2).offset(0x2L));
          MEMORY.ref(2, address).offset(0x10L).offset(i * 0x2L).setu(0);

          if(MEMORY.ref(2, address).offset(0x18L).offset(i * 0x2L).get() == 0xffffL) {
            //LAB_800de0f8
            MEMORY.ref(1, address).offset(0x4L).offset(i).setu(0);
          } else {
            //LAB_800de104
            MEMORY.ref(1, address).offset(0x4L).offset(i).setu(0x1L);
          }
        }
  ...
  public static long FUN_800dfe0c(final HmdSomethingStruct a0) {
    ...
    FUN_80020fe0(struct);
    FUN_800e0d18(struct, _800c6a00.offset(s1 * 0x4L).get(), struct.mrg_124.deref().getFile((int)(s1 * 0x21L + 0x1L)));
  ...
  public static void FUN_800e0d18(final BigStruct a0, final long a1, final long a2) {
    ...
    FUN_80021b08(a0.ObjTable_0c, a0.dobj2ArrPtr_00.deref(), a0.coord2ArrPtr_04.deref(), a0.coord2ParamArrPtr_08.deref(), a0.count_c8.get());

    a0.coord2_14.param.set(a0.coord2Param_64);

    insertCoordinate2(null, a0.coord2_14);
    FUN_80021ca0(a0.ObjTable_0c, a0.tmd_8c.deref(), a0.coord2_14, a0.count_c8.get(), (short)(a0.tmdNobj_ca.get() + 1));
  ...
  @Method(0x800e13b0L)
  public static void FUN_800e13b0(final int index) {
    long v1;
    long s3;
    long s5;
    ...
    switch((int)loadingStage_800c68e4.get()) {
      ...
      case 0x9:
        ...
        //LAB_800e1a38
        for(int i = 0; i < _800c6730.get(); i++) {
          _800c6a00.offset(i * 0x4L).setu(mrg0Addr_800c6878.deref().getAddress() + MEMORY.ref(4, mrg0Addr_800c6878.deref().getAddress() + i * 0x108L + 0x8L).get()); //TODO is this right? What is it doing?
        ...
        //LAB_800e1a8c
        //LAB_800e1abc
        //TODO make sure these loops are right, they look odd
        for(int i = 0; i < _800c6730.get(); i++) {
          //LAB_800e1ae0
        ...
        for(int i = 0; i < _800c6730.get(); i++) {
          ...
          //TODO
          FUN_80020a00(struct, _800c6a00.offset(i * 0x4L).deref(4).cast(ExtendedTmd::new), mrg0Addr_800c6878.deref().getFile((int)s5 / 8));

          if(i == 0) {
            FUN_800e0d18(bigStruct_800c6748, _800c6a00.get(), mrg0Addr_800c6878.deref().getFile(1)); //TODO not sure if this file 1 is right
  ...
  public static void FUN_800e4d88(final int index, final BigStruct struct) {
    if(_800f7e24.get() != 0) {
      if(_800f7e24.get() == 0x1L) {
        struct.coord2_14.coord.set(_800c6ac0);
      } else {
        //LAB_800e4e04
        struct.coord2_14.coord.transfer.set(_800c6ac0.transfer);
      }
  ...
  @Method(0x800e5104L)
  public static void FUN_800e5104(final int index, final long a1) {
    FUN_800e13b0(index);
  ...
  public static void loadBackground(final Value address, final long fileSize, final long param) {
    long s1 = address.get();
    _800cab10.offset(param * 0x4L).setu(0x1L);
  ...
  @Method(0x800e54a4L)
  public static void fileCallback_800e54a4(final Value address, final long fileSize, final long param) {
    _800cab04.setu(_800c6af0.getAddress());
    memcpy(_800c6af0.getAddress(), address.get(), (int)fileSize);
  ...
  public static void FUN_800e59a4() {
    ...
    switch((int)_800cb430.get()) {
      ...
      case 0x1:
        _800cab1c.setu(0);
        FUN_8001524c(_80052c4c.getAddress(), 0, getMethodAddress(SMap.class, "fileCallback_800e54a4", Value.class, long.class, long.class), 0x63L, 0);
        _800cb430.setu(0x2L);
        break;
      ...
      case 0xa:
        ...
        FUN_800e13b0((int)_800caaf8.get());
        _800cb430.setu(0xbL);
        break;

      case 0x9:
        FUN_800e4d00(_80052c30.get(), (int)_80052c34.get());
  ...
  public static void FUN_800e6504(final long a0, final UnsignedIntRef a1, final UnsignedIntRef a2) {
    ...
    v0 = _800cb458.get() + a0 * 0x8L;
    v1 = MEMORY.ref(1, v0).offset(0x1L).get() >>> 5;
    a3 = MEMORY.ref(1, v0).offset(0x3L).get() >>> 5;
    if(v1 == drgnBinIndex_800bc058.get() - 1) {
      a1.set(v1);
      a3 = 0;
    } else if(a3 == drgnBinIndex_800bc058.get() - 1 && a3 <= _800bac60.get()) {
      a1.set(a3);
      a3 = 0x1L;
      //LAB_800e6570
    } else if(a3 >= 0x4L) {
    ...
    //LAB_800e6594
    v1 = a1.get();
    if(v1 == 0 || v1 == 0x1L || v1 == 0x2L || v1 == 0x3L) {
      //LAB_800e65bc
      //LAB_800e65cc
      t0 = 0x4L;
    } else {
  ...
  public static void FUN_800e6f38(long a0) {
    ...
    //LAB_800e6f9c
    for(int i = 0; i < _800cb584.get(); i++) {
      s1 = _800cb718.offset(i * 0x24L).getAddress();

      MEMORY.ref(1, s1).offset(0x3L).setu(0x4L);
      MEMORY.ref(4, s1).offset(0x4L).setu(0x6480_8080L);

      a0 = MEMORY.ref(2, s5).offset(i * 0x24L).offset(0x22L).getSigned();
      s4 = a0 >>> 0x1fL;
      a0 = abs((int)a0);
      if(i < _800cb57c.get()) {
        if((a0 - 0x1f0L) < 0x10L) {
        ...
        MEMORY.ref(2, s1).offset(0xeL).setu(v0);
        s0 = s5 + i * 0x24L;
        memcpy(_800cbb90.offset((i - _800cb57c.get()) * 0x8L).getAddress(), s0 + 0x14L, 8);
        MEMORY.ref(4, s8).offset((i - _800cb57c.get()) * 0x4L).setu(MEMORY.ref(4, s0).offset(0x1cL));
      }
      ...
      MEMORY.ref(1, s1).offset(0x0cL).setu(MEMORY.ref(1, s5).offset(i * 0x24L).offset(0x8L));
      MEMORY.ref(1, s1).offset(0x0dL).setu(MEMORY.ref(1, s5).offset(i * 0x24L).offset(0xaL));
      MEMORY.ref(2, s1).offset(0x10L).setu(MEMORY.ref(2, s5).offset(i * 0x24L).offset(0xcL));
      ...
      if(v1 == 0x4eL) {
        //LAB_800e7148
        MEMORY.ref(2, s3).offset(i * 0x24L).offset(0x20L).setu((0x1L << _1f8003c0.get()) - 0x1L);
      } else if(v1 == 0x4fL) {
        MEMORY.ref(2, s3).offset(i * 0x24L).offset(0x20L).setu(0x28L);
      } else {
        //LAB_800e7194
        a0 = MEMORY.ref(2, s6).offset(0xcL).getSigned() * MEMORY.ref(2, s5).offset(i * 0x24L).getSigned() + MEMORY.ref(2, s6).offset(0xeL).getSigned() * MEMORY.ref(2, s5).offset(i * 0x24L).offset(0x2L).getSigned();
        a0 += MEMORY.ref(2, s6).offset(0x10L).getSigned() * MEMORY.ref(2, s5).offset(i * 0x24L).offset(0x4L).getSigned();
        a0 >>= 12;
        a0 += MEMORY.ref(4, s6).offset(0x1cL).get();
        a0 >>= 0x10L - _1f8003c0.get();
        MEMORY.ref(2, s3).offset(i * 0x24L).offset(0x20L).setu(a0);
      }

      //LAB_800e7210
      MEMORY.ref(2, s3).offset(i * 0x24L).offset(0x22L).and(0x3fffL);
    }
  ...
  public static void FUN_800e7418(final long xy0, final long z0, final long xy1, final long z1, final long rotation, final long projectionDistance) {
    _800cbd10.viewpoint_00.setX((short)xy0);
    _800cbd10.viewpoint_00.setY((short)(xy0 >>> 16));
    _800cbd10.viewpoint_00.setZ((short)z0);
    _800cbd10.refpoint_0c.setX((short)xy1);
    _800cbd10.refpoint_0c.setY((short)(xy1 >>> 16));
    _800cbd10.refpoint_0c.setZ((short)z1);
  ...
  @Method(0x800e8c50L)
  public static void FUN_800e8c50(final GsDOBJ2 dobj2, final SomethingStruct a1, final long src, final int size) {
    memcpy(tmd_800cfa78.getAddress(), src, size);
  ...
  public static void FUN_800e8cd0(final long src, final int size, final long a2, final long a3) {
    ...
    FUN_800e8c50(SomethingStructPtr_800d1a88.deref().dobj2Ptr_20.deref(), SomethingStructPtr_800d1a88.deref(), src, size);
    ...
    final long s0_2 = addToLinkedListTail(0x8L);
    fillMemory(s0_2, 0, 0x8L);
    FUN_800e5084(getMethodAddress(SMap.class, "FUN_800e4f74", long.class, long.class), s0_2, 0);
    _800cbe38.setu(s0_2);
  ...
  public static long get3dAverageOfSomething(final int index, final SVECTOR out) {
    ...
    if(_800f7f14.get() == 0 || index < 0 || index >= SomethingStructPtr_800d1a88.deref().count_0c.get()) {
      //LAB_800e9318
      return 0;
    }

    //LAB_800e932c
    final SomethingStruct2 ss2 = SomethingStructPtr_800d1a88.deref().ptr_14.deref().get(index);
    final long t0 = ss2.ptr_04.get() + 0x6L + SomethingStructPtr_800d1a88.deref().primitives_10.get();
    final int count = ss2.count_00.get();

    //LAB_800e937c
    for(int i = 0; i < count; i++) {
      out.add(MEMORY.ref(4, SomethingStructPtr_800d1a88.deref().verts_04.get()).offset(MEMORY.ref(2, t0).offset(i * 0x2L).get() * 0x8L).cast(SVECTOR::new)); //TODO
    }
  ...
  @Method(0x800edd00L)
  public static void FUN_800edd00(final long a0, final MATRIX a1) {
    ...
    switch((int)(_800f9e5a.get() + 0x1L)) {
      ...
      case 0x2:
        if(_800d4bdc.get() == 0x1L && _800d4be0.get() == 0x1L) {
          ...
          FUN_800edd00(_800d4bec.deref(4).offset(_800d4bec.deref(4).offset(0x10L)).getAddress(), matrix_800d4bb0);
          _800f9e5a.addu(0x1L);
      ...
      case 0x4:
        ...
        //TODO
        FUN_80020a00(_800d4bf8, _800d4be8.deref(4).offset(_800d4be8.deref(4).offset(0x08L)).cast(ExtendedTmd::new), _800d4be8.deref(4).offset(_800d4be8.deref(4).offset(0x10L)).getAddress());
  ...
  public static void FUN_800f2788() {
    ...
    long v0 = mrg_800d6d1c.getAddress();
    //TODO
    FUN_80020a00(_800d5eb0, mrg_800d6d1c.getFile(2, ExtendedTmd::new), v0 + MEMORY.ref(4, v0).offset(0x20L).get());
  ...
  public static void FUN_800f3a48() {
    //TODO file types?
    FUN_800f3c98(mrg_800d6d1c.getFile(0), _800d5588.getAddress());
    FUN_800f3c98(mrg_800d6d1c.getFile(1), _800d5590.getAddress());
    FUN_800f3b64(mrg_800d6d1c.getFile(0), mrg_800d6d1c.getFile(1), _800d4ff0.getAddress(), 0x15L);
  }
