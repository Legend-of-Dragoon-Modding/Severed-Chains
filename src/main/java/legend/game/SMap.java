...
import legend.game.submap.SubmapMediaState;
...
public class SMap extends EngineState {
  ...
  private final Value _800c6ae0 = MEMORY.ref(4, 0x800c6ae0L);
  private final Value _800c6ae4 = MEMORY.ref(4, 0x800c6ae4L);
  ...
  private final Value _800d4d20 = MEMORY.ref(4, 0x800d4d20L);

  private int _800d4d30;
  private int _800d4d34;
  ...
  /** TODO struct */
  private final Value _800d4ee0 = MEMORY.ref(4, 0x800d4ee0L);

  private final Struct34 _800d4f18 = new Struct34();

  private final Value _800d4f48 = MEMORY.ref(4, 0x800d4f48L);
  ...
  private final Value _800d4fe8 = MEMORY.ref(2, 0x800d4fe8L);

  private final ArrayRef<TriangleIndicator44> _800d4ff0 = MEMORY.ref(4, 0x800d4ff0L, ArrayRef.of(TriangleIndicator44.class, 21, 0x44, TriangleIndicator44::new));
  ...
  public FlowControl executeScriptFunction(final int index, final RunningScript<?> script) {
    return switch(index) {
      case 12 -> this.scriptRestoreCharDataVitals(script);
      case 13 -> this.scriptClearStatusEffects(script);
      case 14 -> this.scriptCloneCharacterData(script);
      case 15 -> this.scriptSetCharAddition(script);

      case 18 -> this.scriptGetCharAddition(script);
      case 19 -> this.scriptMaxOutDartDragoon(script);

      case 96 -> this.scriptSelfLoadSobjModelAndAnimation(script);
      case 97 -> this.scriptSelfLoadSobjAnimation(script);
      case 98 -> this.scriptSelfGetSobjAnimation(script);
      case 99 -> this.FUN_800df1f8(script);
      case 100 -> this.FUN_800df228(script);
      case 101 -> this.scriptSetModelPosition(script);
      case 102 -> this.scriptReadModelPosition(script);
      case 103 -> this.scriptSetModelRotate(script);
      case 104 -> this.scriptReadModelRotate(script);
      case 105 -> this.scriptSelfFacePoint(script);
      case 106 -> this.FUN_800df410(script);
      case 107 -> this.FUN_800df440(script);
      case 108 -> this.FUN_800df488(script);
      case 109 -> this.FUN_800df4d0(script);
      case 110 -> this.FUN_800df500(script);
      case 111 -> this.FUN_800df530(script);
      case 112 -> this.FUN_800df560(script);
      case 113 -> this.scriptSelfEnableTextureAnimation(script);
      case 114 -> this.FUN_800df590(script);
      case 115 -> this.scriptSelfDisableTextureAnimation(script);
      case 116 -> this.FUN_800df620(script);
      case 117 -> this.scriptSelfAttachCameraToSobj(script);
      case 118 -> this.scriptSelfIsCameraAttached(script);
      case 119 -> this.scriptSetCameraPos(script);
      case 120 -> this.scriptRotateSobj(script);
      case 121 -> this.scriptRotateSobjAbsolute(script);
      case 122 -> this.FUN_800df904(script);
      case 123 -> this.scriptMovePlayer((RunningScript<SubmapObject210>)script);
      case 124 -> this.scriptFacePlayer(script);
      case 125 -> this.FUN_800df9a8(script);
      case 126 -> this.scriptGetCurrentSubmapId(script);
      case 127 -> this.scriptSelfGetSobjNobj(script);

      case 198 -> this.scriptAddSobjTextbox(script);

      case 256 -> this.scriptMapTransition(script);
      case 257 -> this.scriptGetCameraOffset(script);
      case 258 -> this.scriptSetCameraOffset(script);
      case 259 -> this.scriptGetCollisionAndTransitionInfo(script);
      case 260 -> this.FUN_800e69e8(script);
      case 261 -> this.FUN_800e69f0(script);
      case 262 -> this.FUN_800e6a28(script);
      case 263 -> this.scriptSetEnvForegroundPosition(script);
      case 264 -> this.scriptSetModeParamForNextCallToScriptSetCameraOffsetOrHideSubmapForegroundObject(script);
      case 265 -> this.scriptGetSetEncountersDisabled(script);
      case 266 -> this.FUN_800e6aa0(script);
      case 267 -> this.FUN_800e6b64(script);
      case 268 -> this.FUN_800e6bd8(script);
      case 269 -> this.FUN_800e6be0(script);
      case 270 -> this.FUN_800e6cac(script);
      case 271 -> this.scriptStartFmv(script);

      case 288 -> this.scriptSelfHideModelPart(script);
      case 289 -> this.scriptSelfShowModelPart(script);
      case 290 -> this.scriptSelfFaceCamera(script);
      case 291 -> this.scriptScaleXyz(script);
      case 292 -> this.scriptScaleUniform(script);
      case 293 -> this.scriptSetModelZOffset(script);
      case 294 -> this.scriptSelfSetSobjFlag(script);
      case 295 -> this.FUN_800dfd10(script);
      case 296 -> this.FUN_800de334(script);
      case 297 -> this.FUN_800de4b4(script);
      case 298 -> this.scriptShowAlertIndicator(script);
      case 299 -> this.scriptHideAlertIndicator(script);
      case 300 -> this.FUN_800dfd48(script);
      case 301 -> this.FUN_800e05c8(script);
      case 302 -> this.FUN_800e05f0(script);
      case 303 -> this.scriptEnableSobjFlatLight(script);
      case 304 -> this.scriptDisableSobjFlatLight(script);
      case 305 -> this.scriptSetSobjCollision1(script);
      case 306 -> this.scriptGetSobjCollidedWith1(script);
      case 307 -> this.scriptSetSobjCollision2(script);
      case 308 -> this.scriptGetSobjCollidedWith2(script);
      case 309 -> this.scriptSetAmbientColour(script);
      case 310 -> this.scriptResetAmbientColour(script);
      case 311 -> this.scriptEnableShadow(script);
      case 312 -> this.scriptDisableShadow(script);
      case 313 -> this.scriptSetShadowSize(script);
      case 314 -> this.scriptSetShadowOffset(script);
      case 315 -> this.scriptCheckPlayerCollision((RunningScript<SubmapObject210>)script);
      case 316 -> this.scriptGetPlayerMovement(script);
      case 317 -> this.scriptSwapShadowTexture(script);
      case 318 -> this.scriptSetSobjPlayerCollisionMetrics(script);
      case 319 -> this.FUN_800e0cb8(script);

      case 672 -> this.scriptLoadSobjModelAndAnimation(script);
      case 673 -> this.scriptLoadSobjAnimation(script);
      case 674 -> this.scriptGetSobjAnimation(script);
      case 675 -> this.FUN_800dffa4(script);
      case 676 -> this.FUN_800dffdc(script);
      case 677 -> this.scriptFacePoint(script);
      case 678 -> this.FUN_800e0094(script);
      case 679 -> this.FUN_800de668(script);
      case 680 -> this.FUN_800de944(script);
      case 681 -> this.FUN_800e00cc(script);
      case 682 -> this.FUN_800e0148(script);
      case 683 -> this.FUN_800e01bc(script);
      case 684 -> this.scriptEnableTextureAnimation(script);
      case 685 -> this.FUN_800e0204(script);
      case 686 -> this.scriptDisableTextureAnimation(script);
      case 687 -> this.FUN_800e02c0(script);
      case 688 -> this.scriptAttachCameraToSobj(script);
      case 689 -> this.FUN_800deba0(script);
      case 690 -> this.scriptGetSobjNobj(script);
      case 691 -> this.scriptHideModelPart(script);
      case 692 -> this.scriptShowModelPart(script);
      case 693 -> this.scriptFaceCamera(script);
      case 694 -> this.scriptSetSobjFlag(script);
      case 695 -> this.scriptGetSobjFlag(script);
      case 696 -> this.loadInterpolatedSobjAnimation(script);
      case 697 -> this.loadUninterpolatedSobjAnimation(script);
      case 698 -> this.FUN_800e0184(script);
      case 699 -> this.scriptSetChapterTitleCardReadyToRender(script);
      case 700 -> this.scriptGetChapterTitleCardAnimationComplete(script);
      case 701 -> this.scriptLoadChapterTitleCard(script);
      case 702 -> this.scriptIsChapterTitleCardLoaded(script);
      case 703 -> this.scriptSetTitleCardAnimationPauseTicks(script);

      case 768 -> this.FUN_800f2048(script);
      case 769 -> this.FUN_800f1f9c(script);
      case 770 -> this.FUN_800f1060(script);
      case 771 -> this.FUN_800f2264(script);
      case 772 -> this.scriptAddSavePoint(script);
      case 773 -> this.FUN_800f23ec(script);
      case 774 -> this.FUN_800f2780(script);
      case 775 -> this.FUN_800f2090(script);
      case 776 -> this.FUN_800f2198(script);
      case 777 -> this.FUN_800f1eb8(script);
      case 778 -> this.scriptAllocateTriangleIndicatorArray(script);
      case 779 -> this.FUN_800f1b64(script);
      case 780 -> this.FUN_800f26c8(script);
      case 781 -> this.FUN_800f1d0c(script);
      case 782 -> this.FUN_800f14f0(script);
      case 783 -> this.FUN_800f24d8(script);
      case 784 -> this.FUN_800f24b0(script);
      case 785 -> this.FUN_800f23a0(script);
      case 786 -> this.FUN_800f1634(script);
      case 787 -> this.FUN_800f22c4(script);
      case 788 -> this.FUN_800f2554(script);
      case 789 -> this.FUN_800f25a8(script);
      case 790 -> this.FUN_800f1274(script);
  ...
  private long handleEncounters() {
    if(this._800c6ae0.get() < 0xf || Unpacker.getLoadingFileCount() != 0 || gameState_800babc8.indicatorsDisabled_4e3) {
      return 0;
    }

    this._800c6ae4.addu(0x1L);

    if(this._800c6ae4.getSigned() < 0) {
      return 0;
    }
  ...
  private void loadAndRenderSubmapModelAndEffects(final int index, final MediumStruct a1) {
    ...
    this._800c6ae0.addu(0x1L);

    if(gameState_800babc8.indicatorsDisabled_4e3) {
      this._800c6ae4.setu(-30);
    }
  ...
  public boolean mapTransition(final int newCut, final int newScene) {
    ...
    if((int)this._800c6ae0.get() < 0x3L) {
      return false;
    }
    ...
    if((int)this._800c6ae0.get() > 0xfL) {
      this._800cb448 = false;
    }
    ...
    if(newScene == 0x3fd) {
      ...
      submapCutForSave_800cb450 = (int)_800f7e2c.offset(gameState_800babc8.chapterIndex_98 * 0x8L).get();
      this._800cab24 = this.FUN_800ea974(-0x1L);
      SCRIPTS.pause();
      return true;
    }
      ...
      case RENDER_MENU_14 -> {
        ...
        switch(menu) {
          ...
          case UNLOAD_SAVE_GAME_MENU_20:
            this.smapLoadingStage_800cb430 = SubmapState.RENDER_SUBMAP_12;
            this._800f7e4c = false;
            this.mapTransition((int)_800f7e2c.offset(gameState_800babc8.chapterIndex_98 * 8).get(), (int)_800f7e30.offset(gameState_800babc8.chapterIndex_98 * 8).get());
  ...
  @Method(0x800e6d58L)
  private long FUN_800e6d58(final int submapCut) {
  ...
  private void calculateSubmapBounds(final EnvironmentStruct[] envs, final int backgroundTextureCount) {
    ...
    if(width == 384 && height == 256 || this.FUN_800e6d58(submapCut_80052c30.get()) != 0) {
  ...
  private short FUN_800ea4c8(final int a0) {
    ...
    //LAB_800ea538
    final boolean bool;
    if((int)this._800c6ae0.get() <= 0x400) {
      bool = true;
    ...
    final int s1 = (int)((this._800c6ae0.get() - 1) % 4);
    final int s2 = (int)(this._800c6ae0.get() % 4);
    int s0 = (int)(_800f7f6c.offset(s1 * 0x2L).getSigned() - this._800d1a84);
  ...
  @Method(0x800ea974L)
  private MediumStruct FUN_800ea974(final long a0) {
    if((int)a0 < 0) {
  ...
  private void initSnowEffect(final SnowEffect snow) {
    ...
    if(a0 < 35) {
      ...
      snow.size_14 = 2;
      s2 = this._800d4d34 * 0x5555 >> 16;
      //LAB_800ee6ac
    } else if(a0 < 256) {
      snow.size_14 = 1;
      s2 = this._800d4d34 * 0x5555 >> 15;
    }

    //LAB_800ee6e8
    final long s1 = this._800d4d20.getAddress();
    snow.colour_34 = 0xff;
  ...
  private void FUN_800f00a4(final BoolRef a0, final IntRef a1) {
    ...
    //LAB_800f023c
    if(a1.get() == 1) {
      final long s1 = this._800d4ee0.getAddress();
      ...
      //LAB_800f032c
      this._800d4ee0.offset(2, 0x2L).addu(0x1L);
    }
  ...
  private FlowControl FUN_800f1060(final RunningScript<?> script) {
    if(this._800d4fe8.getSigned() != 0) {
      this._800d4fe8.addu(0x1L);
      return FlowControl.CONTINUE;
    }
  ...
  private FlowControl FUN_800f14f0(final RunningScript<?> script) {
    ...
    final long a1 = this._800d4ee0.getAddress();
    if(v1 != 0) {
  ...
  private FlowControl FUN_800f2198(final RunningScript<?> script) {
    ...
    final long a2 = this._800d4d20.getAddress();
  ...
  private FlowControl FUN_800f24d8(final RunningScript<?> script) {
    ...
    if(this._800f9e70.get() == 0) {
      final long v0 = this._800d4ee0.getAddress();
  ...
  private void renderTriangleIndicators() {
    ...
    for(int indicatorIndex = 0; indicatorIndex < 21; indicatorIndex++) {
      final TriangleIndicator44 s1 = this._800d4ff0.get(indicatorIndex);
  ...
  @Method(0x800f3b64L)
  private void FUN_800f3b64(final AnmFile anm1, final AnmFile anm2, final ArrayRef<TriangleIndicator44> a2, final int count) {
    //LAB_800f3bc4
    for(int i = 0; i < count; i++) {
      ...
      final AnmFile anm;
      if(i == 0) {
        t2.tpage_18.set(this.texPages_800d6050[0]);
        t2.clut_1a.set(this.cluts_800d6068[0]);
        t2.u_1c.set(this.dartArrowU_800d6ca8.get());
        t2.v_20.set(this.dartArrowV_800d6cac.get());
        anm = anm1;
      } else {
        //LAB_800f3bfc
        t2.tpage_18.set(this.texPages_800d6050[1]);
        t2.clut_1a.set(this.cluts_800d6068[1]);
        t2.u_1c.set(this.doorArrowU_800d6cb0.get());
        t2.v_20.set(this.doorArrowV_800d6cb4.get());
        anm = anm2;
      }
