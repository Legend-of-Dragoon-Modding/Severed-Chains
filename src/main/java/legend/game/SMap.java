...
public final class SMap {
  ...
  public static final Value _800c6690 = MEMORY.ref(4, 0x800c6690L);
  public static final Value _800c6694 = MEMORY.ref(4, 0x800c6694L);
  public static final Value _800c6698 = MEMORY.ref(1, 0x800c6698L);
   ...
   *   <li>{@link SMap#FUN_800d963c}</li>
   *   <li>{@link SMap#FUN_800d963c}</li>
   *   <li>{@link SMap#FUN_800d9670}</li>
   *   <li>{@link SMap#FUN_800d96b8}</li>
   *   <li>{@link SMap#FUN_800d9744}</li>
   *   <li>{@link SMap#FUN_800d976c}</li>
   *   <li>{@link SMap#FUN_800d97c4}</li>
   *   <li>{@link SMap#FUN_800d9814}</li>
   *   <li>{@link SMap#FUN_800d98b0}</li>
   *   <li>{@link SMap#FUN_800d992c}</li>
   *   <li>{@link SMap#FUN_800d9970}</li>
   ...
   * </ol>
   */
  public static final ArrayRef<Pointer<SupplierRef<Long>>> _800f48e8 = MEMORY.ref(4, 0x800f48e8L, ArrayRef.of(Pointer.classFor(SupplierRef.classFor(Long.class)), 18, 4, Pointer.deferred(4, SupplierRef::new)));
  ...
  @Method(0x800d92a0L)
  public static void FUN_800d92a0() {
    final long v1 = _800f48e8.get((int)pregameLoadingStage_800bb10c.get()).deref().run();
    ...
    //LAB_800d9374
    if(_800c6698.get() != 0) {
      FUN_8001814c(mcq_800c66a0, 0x280L, 0, -centreScreenX_1f8003dc.getSigned(), -centreScreenY_1f8003de.getSigned(), 0x24L, 0x80L);
    }
  ...
  @Method(0x800d93dcL)
  public static long FUN_800d93dc() {
  ...
  @Method(0x800d963cL)
  public static long FUN_800d963c() {
    if(_800c6694.get() == 0 || fileCount_8004ddc8.get() != 0) {
      //LAB_800d9660
      return 0;
    }
  ...
  @Method(0x800d9a7cL)
  public static void FUN_800d9a7c(final int a0) {
    final McqHeader mcq = mcqs_800c66d0.get(a0).deref();
...
//        primitives += length * 0x2cL;
  ...
  @Method(0x800da754L)
  public static void FUN_800da754(final long a0, long a1, long a2) {
    final long a3 = _800f5930.offset(a2 * 0x14L).getAddress();
    a2 = a0 + 0x10L;
  ...
  @Method(0x800dab7cL)
  public static long renderPrimitive3800(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
  ...
  @Method(0x800daeb8L)
  public static long renderPrimitive3000(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800db790L)
  public static long renderPrimitive3804(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800dbb14L)
  public static long renderPrimitive3004(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800dbde8L)
  public static long renderPrimitive3d(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long length) {
    long packet = linkedListAddress_1f8003d8.get();
    ...
    for(int i = 0; i < length; i++) {
      ...
      if((int)CPU.CFC2(31) >= 0) {
        ...
        if((int)CPU.MFC2(24) > 0) {
          ...
          MEMORY.ref(4, packet).offset(0x30L).setu(MEMORY.ref(4, 0x22L).offset(0x10L).get());
  ...
  @Method(0x800dc164L)
  public static long renderPrimitive35(final long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long length) {
    assert false;
    return 0;
  }
  ...
  @Method(0x800dca90L)
  public static long renderPrimitive3a00(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800dce24L)
  public static long renderPrimitive3200(final long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals) {
    assert false;
    return 0;
  }

  @Method(0x800dd0fcL)
  public static long renderPrimitive3a04(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800dd4e0L)
  public static long renderPrimitive3204(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long normals, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800dd808L)
  public static long renderPrimitive3f(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  @Method(0x800ddb8cL)
  public static long renderPrimitive37(long primitives, final UnboundedArrayRef<SVECTOR> vertices, final long count) {
    long packet = linkedListAddress_1f8003d8.get();
  ...
  public static long FUN_800deba0(final RunningScript a0) {
    ...
    v1 = v1 + 0x6880L;
    v0 = v0 + v1;
    setCallback10((int)MEMORY.ref(4, v0).offset(0x0L).get(), MEMORY.ref(4, getMethodAddress(SMap.class, "FUN_800e3e74", int.class, ScriptState.classFor(BigStruct.class), BigStruct.class), TriFunctionRef::new));
    return 0;
  }
  ...
  public static long FUN_800e0094(final RunningScript a0) {
    scriptStatePtrArr_800bc1c0.get(a0.params_20.get(0).deref().get()).deref().innerStruct_00.derefAs(BigStruct.class).us_128.set(a0.params_20.get(1).deref().get());
    return 0;
  }
  ...
  public static long FUN_800e08f4(final RunningScript a0) {
    a0.params_20.get(1).deref().set((int)scriptStatePtrArr_800bc1c0.get(a0.params_20.get(0).deref().get()).deref().innerStruct_00.derefAs(BigStruct.class).ui_1a8.get());
    return 0;
  }
  ...
  public static long FUN_800e0af4(final RunningScript a0) {
    a0.params_20.get(0).deref().set((int)bigStruct_800c6748.ui_1ac.get());
    a0.params_20.get(1).deref().set((int)bigStruct_800c6748.ui_1b0.get());
    a0.params_20.get(2).deref().set((int)bigStruct_800c6748.ui_1b4.get());
    return 0;
  }
  ...
  public static long FUN_800e1f90(final int index, final ScriptState<BigStruct> scriptState, final BigStruct bigStruct) {
    ...
    if(s1.us_172.get() == 0) {
      ...
      //LAB_800e2140
      final long s3 = FUN_800e88a0(s1.mrgAnimGroup_12e.get(), s1.coord2_14.coord, sp0x20);
      if((int)s3 >= 0) {
  ...
  public static long FUN_800e3e74(final int index, final ScriptState<BigStruct> scriptState, final BigStruct bigStruct) {
    ...
    final long a3 = scriptState.innerStruct_00.getPointer(); //TODO

    MEMORY.ref(4, a3).offset(0x30L).addu(MEMORY.ref(2, a3).offset(0x134L).getSigned());

    final long a0 = MEMORY.ref(4, a3).offset(0x148L).get();
    if((a0 & 0x7fff_ffffL) != 0) {
      a2 = a0;
    }

    //LAB_800e3ea8
    final long v1 = MEMORY.ref(4, a3).offset(0x150L).get();
    if((v1 & 0x7fff_ffffL) != 0) {
      t0 = v1;
    }

    //LAB_800e3ec0
    MEMORY.ref(4, a3).offset(0x160L).addu(MEMORY.ref(4, a3).offset(0x154L).get());
    MEMORY.ref(4, a3).offset(0x168L).addu(MEMORY.ref(4, a3).offset(0x15cL).get());

    if((MEMORY.ref(4, a3).offset(0x160L).get() & 0x1_0000L) != 0) {
      MEMORY.ref(4, a3).offset(0x160L).and(0xffffL);

      if(MEMORY.ref(4, a3).offset(0x148L).getSigned() >= 0) {
        a2 = a2 + 0x1L;
      } else {
        //LAB_800e3f08
        a2 = a2 - 0x1L;
    ...
    //LAB_800e3f0c
    if((MEMORY.ref(4, a3).offset(0x168L).get() & 0x1_0000L) != 0) {
      MEMORY.ref(4, a3).offset(0x168L).and(0xffffL);

      if(MEMORY.ref(4, a3).offset(0x150L).getSigned() >= 0) {
        t0 = t0 + 0x1L;
      } else {
        //LAB_800e3f38
        t0 = t0 - 0x1L;
    ...
    //LAB_800e3f3c
    MEMORY.ref(4, a3).offset(0x2cL).addu(a2);
    MEMORY.ref(4, a3).offset(0x34L).addu(t0);
    MEMORY.ref(2, a3).offset(0x134L).addu(MEMORY.ref(2, a3).offset(0x18cL).get());
    MEMORY.ref(4, a3).offset(0x144L).subu(0x1L);
    if(MEMORY.ref(4, a3).offset(0x144L).get() != 0) {
      return 0;
    }

    //LAB_800e3f7c
    MEMORY.ref(2, a3).offset(0x170L).setu(0);
    MEMORY.ref(2, a3).offset(0x134L).setu(0);
    MEMORY.ref(4, a3).offset(0x2cL).setu(MEMORY.ref(4, a3).offset(0x138L).get());
    MEMORY.ref(4, a3).offset(0x30L).setu(MEMORY.ref(4, a3).offset(0x13cL).get());
    MEMORY.ref(4, a3).offset(0x34L).setu(MEMORY.ref(4, a3).offset(0x140L).get());
    MEMORY.ref(2, a3).offset(0x172L).setu(MEMORY.ref(2, a3).offset(0x174L).get());
    return 1;
  }
  ...
  public static void FUN_800e5934() {
    ...
    if(_800cab2c.get() == 0x1L) {
      FUN_8002aa04();
      _800cb430.setu(0);
      _800cb430.offset(0x10L).setu(_800cab2c.get());
    }
  ...
  public static long FUN_800e6ce0(final RunningScript a0) {
    ...
    submapCut_80052c30.setu(a0.params_20.get(2).deref().get());
  ...
  public static long FUN_800e0710(final RunningScript a0) {
    a0.params_20.get(1).deref().set(scriptStatePtrArr_800bc1c0.get(a0.params_20.get(0).deref().get()).deref().innerStruct_00.derefAs(BigStruct.class).ui_19c.get());
    return 0;
  }
