...
//    sp = oldStackPointer_1f8003b8.get();
  ...
  public static long loadSstrmAndSmap() {
    if(loadingOverlay_8004dd1e.get() == 0) {
      //LAB_80012910
      //LAB_80012900
  ...
  @Method(0x80012b1cL)
  public static void loadAndRunOverlay(final int overlayIndex, final long overlayMethod, final long callbackParam) {
    if(_8004dd10.get() == overlayIndex && loadingOverlay_8004dd1e.get() == 0) {
      _8004dd1c.addu(0x1L);
      MEMORY.ref(4, overlayMethod).cast(ConsumerRef::new).run(callbackParam);
      return;
    }

    //LAB_80012b6c
    //LAB_80012b70
    _8005a2a8.offset(_8004dd14.get() * 12).setu(overlayIndex);
    _8005a2ac.offset(_8004dd14.get() * 12).setu(overlayMethod);
...
//    sp = oldStackPointer_1f8003b8.get();
  ...
  @Method(0x8001814cL)
  public static void FUN_8001814c(final McqHeader a0, long a1, long a2, long a3, final long a4, final long a5, final long a6) {
    long v0;
    long v1;
    long t1;
    long t2;
    ...
    if(a0.magic_00.get() == McqHeader.MAGIC_2) {
      s0 = s0 + a0._28.get();
      s8 = s8 + a0._2a.get();
    }
  ...
  public static void FUN_80018e84() {
    ...
    while(s1 != 0) {
      do {
        ...
        //LAB_80018fa0
        removeFromLinkedList(MEMORY.ref(4, s1).offset(0x4L).get());
        removeFromLinkedList(s1);
        if(s0 == 0) {
          return;
        }
  ...
  public static void FUN_800192d8(long a0, final long a1) {
    final long s0 = addToLinkedListTail(0x10L);
    MEMORY.ref(1, s0).offset(0x3L).setu(0x34L);
    MEMORY.ref(4, s0).offset(0x4L).setu(addToLinkedListTail(0x70L));
    MEMORY.ref(4, s0).offset(0x8L).setu(0);
  ...
  public static void FUN_80019470() {
    ...
    while(s0 != 0) {
      ...
      removeFromLinkedList(MEMORY.ref(4, s0).offset(0x4L).get());
  ...
  public static void FUN_8001b54c() {
    ...
    final long sp10x4 = -displayWidth_1f8003e0.get() / 2;
    final long sp14x4 = -displayHeight_1f8003e4.get() / 2;

    final long a0 = displayHeight_1f8003e4.getSigned() / 8;
...
//    loadDrgnBinFile(0, fileIndex, 0, getMethodAddress(Scus94491BpeSegment.class, "musicPackageLoadedCallback", long.class, long.class, long.class), fileIndex << 8 | a1, 0x4L);
  ...
  public static void FUN_8001ff74() {
    loadAndRunOverlay(1, getMethodAddress(Scus94491BpeSegment.class, "FUN_8001de84", long.class), 0);
  }
