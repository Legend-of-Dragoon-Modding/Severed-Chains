...
public final class Scus94491 {
  ...
  public static final ArrayRef<Pointer<RunnableRef>> vsyncCallbacks_801c64cc = MEMORY.ref(4, 0x801c64ccL, ArrayRef.of(Pointer.classFor(RunnableRef.class), 8, 4, Pointer.of(4, RunnableRef::new)));
  ...
  public static void main() {
    ...
    MEMORY.addFunctions(Scus94491BpeSegment_800f.class);
    Exec(_80188898, 1, 0);
  }
