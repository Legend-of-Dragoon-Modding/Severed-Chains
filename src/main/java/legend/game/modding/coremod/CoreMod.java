...
public class CoreMod {
  ...
  public static final RegistryDelegate<InputAction> INPUT_ACTION_TEXT_CONFIRM = INPUT_ACTION_REGISTRAR.register("text_confirm", InputAction::fixed);
  ...
  public static void registerDefaultInputBindings(final RegisterDefaultInputBindingsEvent event) {
    event
      ...
      .add(INPUT_ACTION_TEXT_CONFIRM.get(), new ButtonInputActivation(InputButton.A))
      .add(INPUT_ACTION_TEXT_CONFIRM.get(), new KeyInputActivation(InputKey.RETURN))
