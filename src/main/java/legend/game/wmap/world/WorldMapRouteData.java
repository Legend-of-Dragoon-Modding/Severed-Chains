...
public record WorldMapRouteData(int legacyIndex, RegistryId start, RegistryId end, RegistryId geometry, int direction, int encounterRate, int battleStage, @Nullable RegistryId encounterPool, int modelIndex, int legacyEncounterPlaceholder, @Nullable RegistryId avatar) {
  public WorldMapRouteData(final RegistryId start, final RegistryId end, final RegistryId geometry, final int direction, final int encounterRate, final int battleStage, @Nullable final RegistryId encounterPool, final int modelIndex) {
  ...
  public WorldMapRouteData withLegacyIndex(final int legacyIndex) {
    return new WorldMapRouteData(legacyIndex, this.start, this.end, this.geometry, this.direction, this.encounterRate, this.battleStage, this.encounterPool, this.modelIndex, this.legacyEncounterPlaceholder, this.avatar);
  }
