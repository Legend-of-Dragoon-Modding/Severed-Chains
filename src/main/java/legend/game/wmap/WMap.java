...
public class WMap extends EngineState {
  ...
  private static final ArrayRef<VECTOR> locationModelTranslationVectors_800c74b8 = MEMORY.ref(4, 0x800c74b8L, ArrayRef.of(VECTOR.class, 0x101, 0x10, VECTOR::new));
                ...
                if(a0._220 == 0) {
                  if(this.worldMapState_800c6698 >= 3 || this.playerState_800c669c >= 3) {
                    ...
                    if(Input.pressedThisFrame(InputAction.BUTTON_NORTH)) {
                      if(this.mapState_800c6798.pathSegmentEndpointTypeCrossed_fc != 1) {
                        if(a0.wmapState_05 == WmapActiveState.ACTIVE) {
                          if(this.mapState_800c6798._d8 == 0) {
                            if(a0.wmapTransitionMode_250 == 0) {
  ...
  private void initWmapAudioVisuals() {
    ...
    if(this.mapState_800c6798.continentIndex_00.ordinal() < Continent.ILLISA_BAY.ordinal()) { // South Serdio, North Serdio, Tiberoa
      loadLocationMenuSoundEffects(1);
    } else {
      //LAB_800cd004
      loadLocationMenuSoundEffects(this.mapState_800c6798.continentIndex_00.ordinal() + 1);
    }
    //LAB_800cd020
  }
  ...
  private void deallocate() {
    if(this.wmapStruct258_800c66a8.mapOverlayObj != null) {
      ...
      this.wmapStruct258_800c66a8.mapOverlayObj = null;
    }
  ...
  private void FUN_800d2fa8() {
    if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 1) {
      return;
    }

    //LAB_800d2fd4
    if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 2 && this.wmapStruct258_800c66a8.wmapState_05 == WmapActiveState.ACTIVE) {
      return;
    }
    ...
    if(struct._110 == 0) {
      if(this.wmapStruct258_800c66a8.zoomState_1f8 == 0) {
        if(!struct.hideAtmosphericEffect_c4) {
          if(this.mapState_800c6798.continentIndex_00 != Continent.ENDINESS) { // Not teleporting
  ...
  private void FUN_800d35fc() {
    ...
    if(v0 == 0) {
      ...
      //LAB_800d3670
      //LAB_800d368c
      if(this.mapState_800c6798.continentIndex_00 != Continent.ENDINESS && this.mapState_800c6798._d8 == 0 && this.tickMainMenuOpenTransition_800c6690 == 0) {
        //LAB_800d36a8
        if(this.mapState_800c6798.pathSegmentEndpointTypeCrossed_fc != 1) {
          if(!this.wmapStruct19c0_800c66b0.mapRotating_80) {
            if(this.wmapStruct258_800c66a8.wmapState_05 == WmapActiveState.ACTIVE) {
  ...
  private void FUN_800d5288() {
    ...
    if(v0 == 0) {
      if(struct._154[0].distanceFromPlayer_04 < 90.0f) {
        struct._11a = 1;
        //LAB_800d52e8
      } else if(this.wmapStruct258_800c66a8.wmapState_05 == WmapActiveState.ACTIVE || struct._c5 != 2) {
        //LAB_800d5328
        struct._11a = 3;
      } else {
        return;
  ...
  private void renderMapOverlay() {
    ...
    //LAB_800d692c
    if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 2) {
      return;
    }
    ...
    if(this.wmapStruct258_800c66a8.mapOverlayObj == null) {
      this.wmapStruct258_800c66a8.mapOverlayObj = new QuadBuilder("WmapName")
        ...
        .size(128.0f, 24.0f)
        .uv(128.0f, this.mapState_800c6798.continentIndex_00.ordinal() * 24.0f)
        .build();
    }
    ...
    if(this.mapState_800c6798.continentIndex_00 == Continent.ENDINESS) {
      return;
    }
  ...
  private void renderPath() {
    ...
    for(int i = 0; i < this.mapState_800c6798.locationCount_08; i++) {
      ...
      if(this.FUN_800eb09c(i, 1, intersectionPoint) == 0) {
        //LAB_800d7db4
        if(this.mapState_800c6798.continentIndex_00 != Continent.ENDINESS || i == 31 || i == 78) {
          transforms.set(lw)
  ...
  private void loadMapModelAssets() {
    this.loadMapModelAndTexture(this.mapState_800c6798.continentIndex_00.ordinal());
  ...
  private void initMapAnimation() {
    ...
    if(this.mapState_800c6798.continentIndex_00 == Continent.TIBEROA) {
      //LAB_800d8f94
  ...
  private void renderWorldMap() {
    ...
    for(int i = 0; i < this.wmapStruct258_800c66a8.tmdRendering_08.count_0c; i++) {
      ...
      if(this.mapState_800c6798.continentIndex_00 != Continent.ENDINESS) {
        //LAB_800d91cc
        if(mapTerrainTmdIndices_800ef194.get(this.mapState_800c6798.continentIndex_00.ordinal()).get() == i || mapFrameTmdIndices_800ef19c.get(this.mapState_800c6798.continentIndex_00.ordinal()).get() == i) {
      ...
      if(this.mapState_800c6798.continentIndex_00.ordinal() < 9 && i == 0) {
    ...
    //LAB_800d942c
    if(this.mapState_800c6798.continentIndex_00.ordinal() < 9) {
  ...
  private void renderAndHandleWorldMap() {
    ...
    //LAB_800d951c
    if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 != 0) {
      return;
    }
    ...
    switch(this.wmapStruct258_800c66a8.zoomState_1f8) {
      ...
      case 2:
        ...
        if(this.wmapStruct258_800c66a8._1f9 >= 18 / vsyncMode_8007a3b8) {
          this.wmapStruct19c0_800c66b0.coord2_20.coord.transfer.set(mapPositions_800ef1a8[this.mapState_800c6798.continentIndex_00.ordinal()]);
  ...
  private void FUN_800d9d24(final int zoomDirection) {
    final Vector3i vec = mapPositions_800ef1a8[this.mapState_800c6798.continentIndex_00.ordinal()];
  ...
  private void FUN_800da248() {
    ...
    //LAB_800da270
    if(struct258.wmapState_05 != WmapActiveState.ACTIVE) {
      return;
    }
    ...
    //LAB_800da420
    if(struct258.wmapTransitionMode_250 == 1) {
      return;
    }
    ...
    if(Input.pressedThisFrame(InputAction.BUTTON_WEST)) { // Square
      ...
      struct258.wmapTransitionMode_250 = 2;
    }

    //LAB_800da520
    if(struct258.wmapTransitionMode_250 != 2) {
      return;
    }
    ...
    switch(struct258._220 + 1) {
      case 1:
        ...
        struct258.svec_208.set(struct258.currPlayerPos_94);
        ...
        struct258.coord2_34.coord.transfer.set(struct258.currPlayerPos_94);
      ...
      case 2:
        ...
        struct258.currPlayerPos_94.y -= 96.0f / (3.0f / vsyncMode_8007a3b8);
        ...
        //LAB_800daab8
        if(struct258.currPlayerPos_94.y < -2500.0f) {
          struct258.currPlayerPos_94.y = -2500.0f;
        }
      ...
      case 3:
        ...
        for(int i = 0; i < 9; i++) {
          //LAB_800dac9c
          if(locations_800f0e34.get(coolonWarpDest_800ef228[i].locationIndex_10).continentNumber_0e.get() == this.mapState_800c6798.continentIndex_00.ordinal() + 1) {
        ...
        //LAB_800dad4c
        if(this.mapState_800c6798.continentIndex_00 == Continent.MILLE_SESEAU) {
          if(struct258.currPlayerPos_94.z < -400.0f) {
        ...
        struct258._220 = 3;
        struct258.currPlayerPos_94.set(coolonWarpDest_800ef228[struct258.coolonWarpIndex_221].vec_00);
        break;
      ...
      case 4:
        if(Input.getButtonState(InputAction.BUTTON_EAST) || Input.getButtonState(InputAction.BUTTON_WEST)) {
          ...
          if(struct258.usingCoolonFromZenebatos_254) {
      ...
      case 6:
        ...
        //LAB_800db4b4
        this.coolonPromptPopup.getSelector().y_3a = struct258._223 * 0x10;
      ...
      case 7:
        ...
        //LAB_800db698
        this.lerp(struct258.currPlayerPos_94, coolonWarpDest_800ef228[struct258.coolonWarpIndex_221].vec_00, coolonWarpDest_800ef228[struct258.coolonWarpIndex_222].vec_00, 36.0f / vsyncMode_8007a3b8 / struct258._218);
      ...
      case 8:
        ...
        if(struct258.coolonWarpIndex_222 == 8) {
          ...
          struct258.wmapTransitionMode_250 = 3;
      ...
      case 0xb:
        ...
        this.wmapStruct19c0_800c66b0.coord2_20.coord.transfer.y = -1500;
        struct258.currPlayerPos_94.set(struct258.svec_208);
        struct258.currPlayerPos_94.y = -5000.0f;
      ...
      case 0xc:
        ...
        if(this.wmapStruct19c0_800c66b0.coord2_20.coord.transfer.y >= struct258.svec_200.y) {
          struct258._220 = 12;
          struct258.currPlayerPos_94.y = -0.09765625f / (3.0f / vsyncMode_8007a3b8); // 100/1024
        }
      ...
      case 0xd:
        struct258.currPlayerPos_94.y += 16.0f / (3.0f / vsyncMode_8007a3b8);

        if(struct258.svec_208.y < struct258.currPlayerPos_94.y) {
          struct258.currPlayerPos_94.y = struct258.svec_208.y;
        }
      ...
      case 0:
        ...
        struct258.wmapTransitionMode_250 = 0;
        struct258._220 = 0;
        return;
    }
  ...
  private void initPlayerModelAndAnimation() {
    ...
    if(modelIndex == 0) {
      ...
      //LAB_800e0114
      if(this.mapState_800c6798.continentIndex_00 == Continent.ENDINESS) { // Teleporting
  ...
  private void FUN_800e06d0() {
    ...
    if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 0) {
      //LAB_800e0760
      this.FUN_800e8a10();
    } else if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 1) {
      //LAB_800e0770
      //LAB_800e0774
      int locationIndex = 0;
      for(int i = 0; i < 6; i++) {
  ...
  private void FUN_800e1364() {
    ...
    if(struct.wmapTransitionMode_250 == 0) {
  ...
  private void renderQueenFuryWake() {
    ...
    final Vector3f delta = new Vector3f(this.wmapStruct258_800c66a8.prevPlayerPos_84)
      .sub(this.wmapStruct258_800c66a8.currPlayerPos_94)
      .normalize()
      .cross(this.shipWakeCrossVector_800c87d8);
    this.FUN_800e2ae4(delta, this.wmapStruct258_800c66a8.currPlayerPos_94);
    this.rotateCoord2(this.wmapStruct258_800c66a8.tmdRendering_08.rotations_08[0], this.wmapStruct258_800c66a8.tmdRendering_08.coord2s_04[0]);
    ...
    for(int i = 0; i < 39; i++) {
      ...
      vertex0.x = spc8 + sp0x98.x;
      vertex0.y = spcc + sp0x98.y;
      vertex0.z = spd0 + sp0x98.z;
      vertex1.x = sp0x98.x;
      vertex1.y = sp0x98.y;
      vertex1.z = sp0x98.z;
      ...
      vertex2.x = spc8 + sp0xa8.x;
      vertex2.y = spcc + sp0xa8.y;
      vertex2.z = spd0 + sp0xa8.z;
      vertex3.set(sp0xa8);

      int baseColour = 256 - sp0x74.get() * 256 / 40;
      ...
      baseColour = 256 - sp0x74.get() * 256 / 40;
      ...
      //LAB_800e2440
      vertex0.x = spd8 + sp0x98.x;
      vertex0.y = spdc + sp0x98.y;
      vertex0.z = spe0 + sp0x98.z;
      vertex2.x = spe8 + sp0xa8.x;
      vertex2.y = spec + sp0xa8.y;
      vertex2.z = spf0 + sp0xa8.z;
  ...
  @Method(0x800e2e1cL)
  private void FUN_800e2e1c(final int index, final Vector3f a1, final Vector3f a2, final IntRef a3, final IntRef a4) {
    if(index == 0) {
      ...
      //LAB_800e3024
      int sp10 = this.wmapStruct258_800c66a8._230 - index * this.wmapStruct258_800c66a8._23c;
  ...
  private void FUN_800e3fac(final int a0) {
    ...
    this.wmapStruct258_800c66a8.wmapState_05 = WmapActiveState.values()[a0 + 1];
  }
  ...
  private void FUN_800e406c() {
    if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 1) {
      ...
      if(v0 == 1) {
        ...
        if(this.wmapStruct19c0_800c66b0._c5 == 0 && this.mapState_800c6798._d4 == 0) {
          this.mapState_800c6798.disableInput_d0 = false;
          this.wmapStruct258_800c66a8.wmapState_05 = WmapActiveState.ACTIVE;
          this.wmapStruct258_800c66a8._04 = 2;
        }
        //LAB_800e4478
    ...
    } else if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 0 || this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 2) {
      //LAB_800e40c0
      final int v0 = this.wmapStruct258_800c66a8._04;
      if(v0 == 1) {
        //LAB_800e4304
      ...
      if(this.wmapStruct19c0_800c66b0._10e >= 16.0f) {
        if(this.wmapStruct258_800c66a8.colour_20 == 0.0f) {
          ...
          if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 2) {
            this.wmapState_800bb10c = WmapState.TRANSITION_TO_SUBMAP_7;
            //LAB_800e48f4
          } else if(this.wmapStruct258_800c66a8.wmapTransitionMode_250 == 3) {
            this.wmapState_800bb10c = WmapState.TRANSITION_TO_WORLD_MAP_9;
          }
        }
      }
  ...
  private void renderMapBackground() {
    ...
    //LAB_800e4eac
    if(this.wmapStruct258_800c66a8.wmapState_05 != WmapActiveState.TRANSITION_OUT) {
      this.mcqColour_800c6794 += 0.125f / (3.0f / vsyncMode_8007a3b8);
  ...
  private void handleStartButtonLocationLabels() {
    ...
    for(int i = 0; i < this.placeCount_800c86cc; i++) {
      ...
      if(!places_800f0234.get(locations_800f0e34.get(locationsIndices_800c84c8.get(i).get()).placeIndex_02.get()).name_00.isNull()) {
        ...
        GTE.perspectiveTransform(locationModelTranslationVectors_800c74b8.get(i));
  ...
  private void FUN_800e78c0() {
    ...
    this.mapState_800c6798.continentIndex_00 = Continent.values()[locations_800f0e34.get(locationIndex).continentNumber_0e.get() - 1];
    continentIndex_800bf0b0.set(this.mapState_800c6798.continentIndex_00.ordinal());
    ...
    if(!transitionFromCombatOrShip && !loadingNewGameState_800bdc34.get() || reinitializingWmap_80052c6c) {
      ...
      if(directionalPathSegment.pathSegmentIndexAndDirection_00.get() >= 0) {
        ...
        //LAB_800e8190
        final int index = pathSegmentLengths_800f5810[Math.abs(directionalPathSegment.pathSegmentIndexAndDirection_00.get()) - 1] - 1;
    ...
    //LAB_800e8720
    this.wmapStruct258_800c66a8.wmapTransitionMode_250 = 0;
  ...
  private void FUN_800e8cb0() {
    ...
    if(this.mapState_800c6798.dotOffset_18 >= 4.0f) {
      ...
      final int maxDotIndex = pathSegmentLengths_800f5810[Math.abs(directionalPathSegmentData_800f2248.get(this.mapState_800c6798.directionalPathIndex_12).pathSegmentIndexAndDirection_00.get()) - 1] - 1;
  ...
  private void processInput() {
    //LAB_800e912c
    if(Unpacker.getLoadingFileCount() != 0 || this.wmapStruct258_800c66a8.wmapState_05 != WmapActiveState.ACTIVE) {
      return;
    }
  ...
  private void FUN_800e975c() {
    ...
    if(index == 1) {
      ...
      //LAB_800e9d48
      this.mapState_800c6798.pathSegmentEndpointTypeCrossed_fc = 2;
    }
    //LAB_800e9d54
  }
  ...
  private void FUN_800ea4dc(final int directionalPathIndex) {
    ...
    for(i = 0; i < this.mapState_800c6798.locationCount_08; i++) {
      ...
      if(locations_800f0e34.get(i).directionalPathIndex_00.get() != -1) {
        ...
        if(this.FUN_800eb09c(i, 0, null) == 0) {
          //LAB_800ea578
          if(locations_800f0e34.get(i).continentNumber_0e.get() == this.mapState_800c6798.continentIndex_00.ordinal() + 1) {
            //LAB_800ea5bc
  ...
  private void FUN_800ea630(final int locationIndex) {
    ...
    //LAB_800ea678
    if(locations_800f0e34.get(locationIndex).continentNumber_0e.get() != this.mapState_800c6798.continentIndex_00.ordinal() + 1) {
      return;
    }
    ...
    if(directionalPathSegment.pathSegmentIndexAndDirection_00.get() >= 0) {
      ...
      //LAB_800ea8d4
      final int dotIndex = pathSegmentLengths_800f5810[Math.abs(directionalPathSegment.pathSegmentIndexAndDirection_00.get()) - 1] - 1;
    ...
    for(int i = 0; i < this.mapState_800c6798.locationCount_08; i++) {
      ...
      if(this.FUN_800eb09c(i, 0, null) == 0) {
        ...
        if(!sp0xd0[i]) {
          ...
          //LAB_800eb694
          if(sp20 == 1) {
            locationModelTranslationVectors_800c74b8.get(effectCount).set(sp0x60[0]);
          } else {
            //LAB_800eb724
            sp0x30.set(sp0x60[0]);
            ...
            //LAB_800eb828
            locationModelTranslationVectors_800c74b8.get(effectCount).set(sp0x50);
          }
  ...
  private void renderClouds() {
    ...
    for(int i = 0; i < 24; i++) {
      ...
      if(this.wmapStruct19c0_800c66b0.hideAtmosphericEffect_c4) {
        ...
        //LAB_800ec34c
        if(struct.wmapState_05 == WmapActiveState.TRANSITION_OUT) {
          cloud.brightness_5c -= 0.125f / (3.0f / vsyncMode_8007a3b8);
  ...
  private void renderSmoke() {
    ...
    for(int i = 0; i < this.placeCount_800c86cc; i++) {
      ...
      //LAB_800edda0
      if(locations_800f0e34.get(locationsIndices_800c84c8.get(i).get()).continentNumber_0e.get() == this.mapState_800c6798.continentIndex_00.ordinal() + 1) {
        //LAB_800eddfc
        if(i >= 9) {
          break;
        }
        ...
        for(int j = 0; j < 6; j++) {
          ...
          //LAB_800edebc
          //LAB_800edf88
          smoke.coord2_00.coord.transfer.x = locationModelTranslationVectors_800c74b8.get(i).getX() + smoke.translationOffset_54.x * smoke.scaleAndColourFade_50 / 16;
          smoke.coord2_00.coord.transfer.y = locationModelTranslationVectors_800c74b8.get(i).getY() + smoke.translationOffset_54.y * smoke.scaleAndColourFade_50 / 4;
          smoke.coord2_00.coord.transfer.z = locationModelTranslationVectors_800c74b8.get(i).getZ() + smoke.translationOffset_54.z * smoke.scaleAndColourFade_50 / 16;

          if(this.mapState_800c6798.continentIndex_00 == Continent.SOUTH_SERDIO) {
            if(mode == 4) {
              //LAB_800ee0e4
              smoke.coord2_00.coord.transfer.x = locationModelTranslationVectors_800c74b8.get(i).getX() + smoke.translationOffset_54.x * smoke.scaleAndColourFade_50 / 16;
              smoke.coord2_00.coord.transfer.y = locationModelTranslationVectors_800c74b8.get(i).getY() + smoke.translationOffset_54.y * smoke.scaleAndColourFade_50 / 4;
              smoke.coord2_00.coord.transfer.z = locationModelTranslationVectors_800c74b8.get(i).getZ() + smoke.translationOffset_54.z * smoke.scaleAndColourFade_50 / 16 + 80;
              //LAB_800ee1dc
            } else if(mode == 8) {
              //LAB_800ee238
              smoke.coord2_00.coord.transfer.x = locationModelTranslationVectors_800c74b8.get(i).getX() + smoke.translationOffset_54.x * smoke.scaleAndColourFade_50 / 16 + 48;
              smoke.coord2_00.coord.transfer.y = locationModelTranslationVectors_800c74b8.get(i).getY() + smoke.translationOffset_54.y * smoke.scaleAndColourFade_50 / 4;
              smoke.coord2_00.coord.transfer.z = locationModelTranslationVectors_800c74b8.get(i).getZ() + smoke.translationOffset_54.z * smoke.scaleAndColourFade_50 / 16 + 48;
            }

            //LAB_800ee32c
            //LAB_800ee334
          } else if(this.mapState_800c6798.continentIndex_00 == Continent.NORTH_SERDIO) {
            if(mode == 4) {
              //LAB_800ee3a4
              smoke.coord2_00.coord.transfer.x = locationModelTranslationVectors_800c74b8.get(i).getX() + smoke.translationOffset_54.x * smoke.scaleAndColourFade_50 / 16;
              smoke.coord2_00.coord.transfer.y = locationModelTranslationVectors_800c74b8.get(i).getY() + smoke.translationOffset_54.y * smoke.scaleAndColourFade_50 / 4 + 48;
              smoke.coord2_00.coord.transfer.z = locationModelTranslationVectors_800c74b8.get(i).getZ() + smoke.translationOffset_54.z * smoke.scaleAndColourFade_50 / 16 - 100;
              //LAB_800ee4a0
            } else if(mode == 8) {
              //LAB_800ee4fc
              smoke.coord2_00.coord.transfer.x = locationModelTranslationVectors_800c74b8.get(i).getX() + smoke.translationOffset_54.x * smoke.scaleAndColourFade_50 / 16 - 48;
              smoke.coord2_00.coord.transfer.y = locationModelTranslationVectors_800c74b8.get(i).getY() + smoke.translationOffset_54.y * smoke.scaleAndColourFade_50 / 4;
              smoke.coord2_00.coord.transfer.z = locationModelTranslationVectors_800c74b8.get(i).getZ() + smoke.translationOffset_54.z * smoke.scaleAndColourFade_50 / 16 + 32;
            }
          }
