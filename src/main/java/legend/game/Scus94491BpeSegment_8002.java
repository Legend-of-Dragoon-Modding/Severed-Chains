...
import static legend.game.Scus94491BpeSegment_8005._80052e38;
import static legend.game.Scus94491BpeSegment_8005._80052e3c;
import static legend.game.Scus94491BpeSegment_8005._80052e40;
...
public final class Scus94491BpeSegment_8002 {
  ...
  @Method(0x80022898L)
  public static long FUN_80022898(final long a0) {
    if(a0 >= 0xc0L) {
      return 0;
    }

    //LAB_800228b0
    return _80111ff0.offset(a0 * 0x1cL).get() & 0x4L;
  }
  ...
  public static long FUN_80022afc(final long a0) {
    if(a0 < 0xc0L || a0 == 0xffL) {
      return 0;
    }

    final long v1 = _8004f2ac.offset((a0 - 0xc0L) * 0xcL).get();
  ...
  /** TODO why does this method copy 0x30 bytes from the stack but only sets 8? */
  @Method(0x80022d88L)
  public static long FUN_80022d88(final long a0, long a1, final int charIndex) {
    long v0;
    long v1;
    long s1 = a1;
    long s0 = s1 & 0xffL;

    final Memory.TemporaryReservation sp0x10 = MEMORY.temp(0x30);
    final Value sp10 = sp0x10.get();
    final Value sp14 = sp0x10.get().offset(0x4L);
    ...
    //LAB_80022e94
    s0 = s1 + 0x40L & 0xffL;
    a1 = _8004f2ac.offset(s0 * 0xcL).getAddress(); //TODO struct
    s1 = MEMORY.ref(1, a1).offset(0x9L).get();
    if((MEMORY.ref(1, a1).offset(0xbL).get() & 0x80L) != 0) {
      if((MEMORY.ref(1, a1).offset(0x0L).get() & 0x2L) == 0) {
        v1 = 0x2L;
      } else {
        v1 = 0x3L;
      }
      ...
      if(s1 == 100) {
        ...
        //LAB_80022ef0
        v0 = stats_800be5f8.get(charIndex).maxHp_66.get() * s1 / 100;
      }

      //LAB_80022f3c
      sp14.setu(addHp(charIndex, (int)v0));
    }

    //LAB_80022f50
    a1 = _8004f2ac.offset(s0 * 0xcL).getAddress();

    if((MEMORY.ref(1, a1).offset(0xbL).get() & 0x40L) != 0) {
      if((MEMORY.ref(1, a1).offset(0x0L).get() & 0x2L) == 0) {
        v1 = 0x4L;
      } else {
        v1 = 0x5L;
      ...
      if(s1 == 100) {
        ...
        //LAB_80022fac
        v0 = stats_800be5f8.get(charIndex).maxMp_6e.get() * s1 / 100;
      }
    ...
    //LAB_8002300c
    if((_8004f2ac.offset(s0 * 0xcL).offset(0xbL).get() & 0x20L) != 0) {
      sp10.setu(0x6L);
      ...
      //LAB_80023050
      sp14.setu(FUN_80022cd0(charIndex, v0));
    }

    //LAB_80023068
    a1 = _8004f2ac.offset(s0 * 0xcL).getAddress();

    if((MEMORY.ref(1, a1).offset(0xbL).get() & 0x8L) != 0) {
      v1 = gameState_800babc8.charData_32c.get(charIndex)._10.get();

      if((MEMORY.ref(1, a1).offset(0x8L).get() & v1) != 0) {
        sp14.setu(v1);
        gameState_800babc8.charData_32c.get(charIndex)._10.not();
      }
  ...
  public static long FUN_80023978(final long a0, final long a1) {
    ...
    //LAB_800239c8
    return MEMORY.ref(1, a0).get() - MEMORY.ref(1, a1).get();
  }

  @Method(0x800239e0L)
  public static void FUN_800239e0(final long a0, final ArrayRef<UnsignedByteRef> a1, final long a2) {
    //LAB_800239ec
    int a3 = 0;
    for(int i = 0; i < a2; i++) {
      if((MEMORY.ref(2, a0).offset(i * 0x4L).offset(0x2L).get() & 0x1000L) == 0) {
        a1.get(a3).set((int)MEMORY.ref(1, a0).offset(i * 0x4L).get());
        a3++;
      }
    ...
    if((int)a3 <= 0) {
      ...
      do {
        ...
        if(v0 == 0) {
          ...
          v1 = MEMORY.ref(2, v1).offset(-6728L).get();
          a0 = MEMORY.ref(2, a0).offset(-6712L).get();
          s4 = MEMORY.ref(2, a1).offset(-6720L).get();
          s6 = v0;
          v0 = s6 + 0x14L;
          MEMORY.ref(4, a3).offset(0x3d8L).setu(v0);
          v0 = 0x800c_0000L;
          v0 = MEMORY.ref(2, v0).offset(-6724L).get();
          a2 = a2 | 0x8080L;
          sp18 = v1;
          sp20 = a0;
          sp22 = v0;
  ...
  public static void FUN_8002a6fc() {
    ...
    for(int charIndex = 0; charIndex < 9; charIndex++) {
      ...
      stats.spPerPhysicalHit_52.set((short)0);
      stats.mpPerPhysicalHit_54.set((short)0);
  ...
  public static long FUN_8002ae0c(final int a0) {
    ...
    for(int joypadIndex = 0; joypadIndex < maxJoypadIndex_80059628.get() + 1 /* this was hardcoded to 2 joypads */; joypadIndex++) {
      ...
      do {
        ...
        s0 = FUN_8002b250(_800bed60.get(joypadIndex).b84.get(), _800bed60.get(joypadIndex), a0, joypadIndex);
  ...
  public static int FUN_8002b0bc(final JoyStruct joyStruct, final int joypadIndex) {
    ...
    //caseD_8
    if(gameState_800babc8.vibrationEnabled_4e1.get() == 0 || _800bee80.get(0).get() != 0) {
      //LAB_8002b17c
...
//    MEMORY.ref(4, epc).call();
  ...
  @Method(0x8002e75cL)
  public static long FUN_8002e75c(final long a0) {
    final long v1 = MEMORY.ref(4, a0).get();
    ...
    if(v1 == 0xaL) {
      //LAB_8002e7cc
      if(memcardState_800bf174.get() != 0) {
        return 0x1L;
      }
    ...
    if(v1 == 0x1eL) {
      ...
      final long status = awaitMemcard();
      if(status == 0) {
        memcardState_800bf174.setu(getMemcardState(status));
        return 0x1L;
      }

      _80052e38.addu(0x1L);

      if(_80052e38.get() < 0x4L) {
        MEMORY.ref(4, a0).setu(0xaL);
      } else {
        //LAB_8002e88c
        if(status != 0x4L) {
  ...
  @Method(0x8002e908L)
  public static long readMemcardFile(final long port, final String saveName, final long memcardDest, final long memcardPos, final long memcardLength) {
    if((int)activeMemcardEvent_800bf170.get() > 0) {
    ...
    getDevice(port, memcardFilename_800bf194);
    strcat(memcardFilename_800bf194, saveName);
  ...
  @Method(0x8002eb28L)
  public static long FUN_8002eb28(final long port, final String file, final long dest, final long pos, final long length) {
    if((int)activeMemcardEvent_800bf170.get() > 0) {
      throw new RuntimeException("Access denied: system busy");
    }
    ...
    //LAB_8002eb9c
    if((length & 0x7fL) != 0) {
      throw new RuntimeException("Access denied: invalid data alignment");
    }
    ...
    if((pos & 0x7fL) != 0) {
      //LAB_8002ec04
      //LAB_8002ec0c
      throw new RuntimeException("Access denied: invalid offset alignment");
    }

    getDevice(port, memcardFilename_800bf194);
    strcat(memcardFilename_800bf194, file);
    activeMemcardEvent_800bf170.setu(0x4L);
    memcardState_800bf174.setu(0);
    _800bf178.setu(0);
    cardPort_800bf180.setu(port);
...
//    setMemcardVsyncCallback(getMethodAddress(Scus94491BpeSegment_8002.class, "FUN_8002ec40", long.class));
  ...
  @Method(0x8002ec40L)
  public static long FUN_8002ec40(final long a0) {
    final long v1 = MEMORY.ref(4, a0).get();
    ...
    if(v1 == 0xaL) {
      ...
      memcardFileHandle_800bf184.set(open(memcardFilename_800bf194.get(), 0x8001));
      if(memcardFileHandle_800bf184.get() < 0) {
        memcardState_800bf174.setu(0x5L);
        return 1;
      }

      //LAB_8002ecf0
      MEMORY.ref(4, a0).setu(0x14L);
      setMemcardVsyncCallback(getMethodAddress(Scus94491BpeSegment_8002.class, "FUN_8002e75c", long.class));
      return 0;
    }
...
//      }
  ...
  @Method(0x8002f0d4L)
  public static long FUN_8002f0d4(final long port, final String file, final long a2) {
    if(activeMemcardEvent_800bf170.get() != 0) {
      throw new RuntimeException("Access denied: system busy");
    }
    ...
    final long a0 = FUN_80030320((int)port, file, a2);
    if(a0 == 0) {
      //LAB_8002f1b0
      return 0;
    }
  ...
  /** Out is a 6-byte cstring */
  @Method(0x8002f344L)
  public static void getDevice(final long port, final CString out) {
    out.set(bu00_80011174.get());
    ...
    out.charAt(2, (char)('0' + joypadIndex));
    out.charAt(3, (char)('0' + port - joypadIndex * 0x10));
  }
  ...
  @Method(0x8002f59cL)
  public static DIRENTRY FUN_8002f59c(final long a0, final String a1, final DIRENTRY a2) {
  ...
  @Method(0x8002f6c0L)
  public static String printf(final String fmt, final String... args) {
    return (String)functionVectorA_000000a0.run(0x3fL, new Object[] {fmt, args});
  }
