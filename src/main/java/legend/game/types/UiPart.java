...
public record UiPart(RenderableMetrics14[] metrics_00, int ticksPerFrame) {
  public static UiPart fromFile(final FileData data, final FileData partData, final FileData entryIndicesData) {
    final int ticksPerFrame = partData.readUByte(0x2);
    ...
    return new UiPart(metrics_00, ticksPerFrame);
  }
}
