...
public class SpuStruct124 implements MemoryRef {
  ...
  public final UnsignedByteRef _0e9;
  public final UnsignedByteRef _0ea;

  public final UnsignedShortRef _0ec;
  public final UnsignedShortRef _0ee;
  public final UnsignedShortRef _0f0;
  ...
  public SpuStruct124(final Value ref) {
    ...
    this._000 = ref.offset(1, 0x000L).cast(UnsignedByteRef::new);
    ...
    this._0e9 = ref.offset(1, 0x0e9L).cast(UnsignedByteRef::new);
    this._0ea = ref.offset(1, 0x0eaL).cast(UnsignedByteRef::new);

    this._0ec = ref.offset(2, 0x0ecL).cast(UnsignedShortRef::new);
    this._0ee = ref.offset(2, 0x0eeL).cast(UnsignedShortRef::new);
    this._0f0 = ref.offset(2, 0x0f0L).cast(UnsignedShortRef::new);
