...
public class JoyData implements MemoryRef {
  ...
  public final Pointer<FunctionRef<JoyData, Integer>> func18;
  // Unknown
  ...
  public final ArrayRef<UnsignedByteRef> byteArr51;
  public final ByteRef byte53;
  // Unknown
  public final ArrayRef<UnsignedByteRef> byteArr57;
  public final ArrayRef<UnsignedByteRef> byteArr5d;
  ...
  public JoyData(final Value ref) {
    ...
    this.byteArr51 = ref.offset(2, 0x51L).cast(ArrayRef.of(UnsignedByteRef.class, 2, 1, UnsignedByteRef::new));
    ...
    this.byteArr5d = ref.offset(6, 0x5dL).cast(ArrayRef.of(UnsignedByteRef.class, 6, 1, UnsignedByteRef::new));
