...
public class MrgFile implements MemoryRef {
  ...
  public final UnsignedIntRef count;
  ...
  public MrgFile(final Value ref) {
    ...
    this.count = ref.offset(4, 0x4L).cast(UnsignedIntRef::new);
    this.entries = ref.offset(4, 0x8L).cast(UnboundedArrayRef.of(8, MrgEntry::new, this::getCount));
  }
