...
public class ScriptFile implements MemoryRef {
  ...
  public final ArrayRef<RelativePointer<UnsignedIntRef>> offsetArr_00;
  public final UnboundedArrayRef<UnsignedIntRef> code_40;

  public ScriptFile(final Value ref) {
    this.ref = ref;

    this.offsetArr_00 = ref.offset(4, 0x00L).cast(ArrayRef.of(RelativePointer.classFor(UnsignedIntRef.class), 0x10, 4, RelativePointer.deferred(4, ref.getAddress(), UnsignedIntRef::new)));
