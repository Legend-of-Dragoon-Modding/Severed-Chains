...
public class RunningScript implements MemoryRef {
  ...
  public final Pointer<IntRef> parentPtr_08;
  ...
  public RunningScript(final Value ref) {
    ...
    this.parentPtr_08 = ref.offset(4, 0x08L).cast(Pointer.deferred(4, IntRef::new));
    ...
    this.params_20 = ref.offset(4, 0x20L).cast(ArrayRef.of(Pointer.classFor(IntRef.class), 9, 4, Pointer.deferred(4, IntRef::new))); //TODO unsure how many elements
  }
