...
//    wasteSomeCycles();
  ...
  @Method(0x8004d6a8L)
  public static long sssqPitchShift(final long a0, final long a1, final long a2, final long pitchShiftVolLeft, final long pitchShiftVolRight, final long pitch) {
    assert false;
    return 0;
  }
