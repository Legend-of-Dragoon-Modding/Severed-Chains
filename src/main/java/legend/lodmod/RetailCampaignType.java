...
public class RetailCampaignType extends CampaignType {
  ...
  public void setUpNewCampaign(final GameState52c gameState) {
    ...
    dart.stats.getStat(HP_STAT.get()).restore();
    dart.stats.getStat(MP_STAT.get()).restore();
    ...
    lavitz.stats.getStat(HP_STAT.get()).restore();
    lavitz.stats.getStat(MP_STAT.get()).restore();
    ...
    shana.stats.getStat(HP_STAT.get()).restore();
    shana.stats.getStat(MP_STAT.get()).restore();
    ...
    rose.stats.getStat(HP_STAT.get()).restore();
    rose.stats.getStat(MP_STAT.get()).restore();
    ...
    haschel.stats.getStat(HP_STAT.get()).restore();
    haschel.stats.getStat(MP_STAT.get()).restore();
    ...
    albert.stats.getStat(HP_STAT.get()).restore();
    albert.stats.getStat(MP_STAT.get()).restore();
    ...
    meru.stats.getStat(HP_STAT.get()).restore();
    meru.stats.getStat(MP_STAT.get()).restore();
    ...
    kongol.stats.getStat(HP_STAT.get()).restore();
    kongol.stats.getStat(MP_STAT.get()).restore();
    ...
    miranda.stats.getStat(HP_STAT.get()).restore();
    miranda.stats.getStat(MP_STAT.get()).restore();
