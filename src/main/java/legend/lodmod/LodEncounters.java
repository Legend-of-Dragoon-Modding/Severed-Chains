...
public final class LodEncounters {
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_SELES_COMMANDER = ENCOUNTER_REGISTRAR.register("seles_commander", () -> new Encounter(240, 0, 0, 0, 22, 58, 58, 58, 65535, 255, new Encounter.Monster(257, new Vector3f(-2560.000000f, 0.000000f, -1536.000000f)), new Encounter.Monster(257, new Vector3f(-2560.000000f, 0.000000f, 1536.000000f)), new Encounter.Monster(256, new Vector3f(-4224.000000f, 0.000000f, 128.000000f))));
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_DRAKE_THE_BANDIT = ENCOUNTER_REGISTRAR.register("drake_the_bandit", () -> new Encounter(240, 0, 23, 5, 69, 69, 69, 57, 65535, 255, new Encounter.Monster(325, new Vector3f(-6016.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(326, new Vector3f(-6016.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(327, new Vector3f(-6016.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(327, new Vector3f(-6016.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(327, new Vector3f(-6016.000000f, 0.000000f, 128.000000f))));
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_FIRE_BIRD = ENCOUNTER_REGISTRAR.register("fire_bird", () -> new Encounter(240, 0, 5, 5, 51, 85, 67, 98, 65535, 255, new Encounter.Monster(333, new Vector3f(-3712.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(334, new Vector3f(-3712.000000f, 0.000000f, 1152.000000f)), new Encounter.Monster(334, new Vector3f(-3712.000000f, 0.000000f, 2176.000000f)), new Encounter.Monster(334, new Vector3f(-3712.000000f, 0.000000f, -896.000000f)), new Encounter.Monster(334, new Vector3f(-3712.000000f, 0.000000f, -1920.000000f))));
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_KAMUY = ENCOUNTER_REGISTRAR.register("kamuy", () -> new Encounter(240, 0, 5, 5, 54, 63, 78, 84, 65535, 255, new Encounter.Monster(343, new Vector3f(-7552.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(339, new Vector3f(-7552.000000f, 0.000000f, 128.000000f))));
  ...
  public static final String[] LEGACY = {
    ...
    "melbu_frahma",
    "melbu_frahma_test",
    "melbu_frahma_with_tentacles_test",
    "melbu_frahma_tentacle_test",
