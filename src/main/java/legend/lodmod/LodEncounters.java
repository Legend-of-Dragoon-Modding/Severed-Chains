...
public final class LodEncounters {
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_LLOYD = ENCOUNTER_REGISTRAR.register("lloyd", () -> new Encounter(241, 0, 23, 23, 20, 58, 20, 58, 65535, 255, new Encounter.Monster(269, new Vector3f(-4480.000000f, 0.000000f, 128.000000f))));
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_DIVINE_DRAGON_DIVINE_CANNON_DIVINE_BALL = ENCOUNTER_REGISTRAR.register("divine_dragon_divine_cannon_divine_ball", () -> new Encounter(241, 0, 30, 30, 54, 75, 74, 54, 424, 12, new Encounter.Monster(283, new Vector3f(-216.000000f, 0.000000f, 128.000000f)), new Encounter.Monster(284, new Vector3f(-11584.000000f, 0.000000f, -2120.000000f)), new Encounter.Monster(285, new Vector3f(-6784.000000f, 0.000000f, 128.000000f))));
  ...
  public static final RegistryDelegate<Encounter> ENCOUNTER_GORGAGA = ENCOUNTER_REGISTRAR.register("gorgaga", () -> new Encounter(240, 0, 18, 6, 27, 64, 64, 64, 65535, 255, new Encounter.Monster(302, new Vector3f(-3712.000000f, 0.000000f, 128.000000f))));
  public static final RegistryDelegate<Encounter> ENCOUNTER_SERFIUS = ENCOUNTER_REGISTRAR.register("serfius", () -> new Encounter(240, 0, 18, 6, 27, 64, 64, 64, 65535, 255, new Encounter.Monster(303, new Vector3f(-4480.000000f, 0.000000f, 128.000000f))));
  public static final RegistryDelegate<Encounter> ENCOUNTER_DANTON = ENCOUNTER_REGISTRAR.register("danton", () -> new Encounter(240, 0, 18, 6, 27, 64, 64, 64, 65535, 255, new Encounter.Monster(304, new Vector3f(-3840.000000f, 0.000000f, 0.000000f))));
  public static final RegistryDelegate<Encounter> ENCOUNTER_ATLOW = ENCOUNTER_REGISTRAR.register("atlow", () -> new Encounter(240, 0, 18, 6, 27, 64, 64, 64, 65535, 255, new Encounter.Monster(305, new Vector3f(-3712.000000f, 0.000000f, 128.000000f))));
