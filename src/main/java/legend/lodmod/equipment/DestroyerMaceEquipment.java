...
public class DestroyerMaceEquipment extends Equipment {
  public DestroyerMaceEquipment(final int price) {
    super(price, 0, EquipmentSlot.WEAPON, LodMod.NO_ELEMENT.get(), new ElementSet(), new ElementSet(), 0, 0, 0, 0, 0, 0, 0, 0, false, false, false, false, 0, 0, 0, 0, 0, ItemIcon.KNUCKLE, 0, 55, 0, 0, 0, 0, 0, 0, 0, 0, 0);
  }
