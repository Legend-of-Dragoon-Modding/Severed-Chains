...
public final class LodGoods {
  ...
  public static final RegistryDelegate<Good> RED_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("red_dragoon_spirit", () -> new Good(10));
  public static final RegistryDelegate<Good> BLUE_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("blue_dragoon_spirit", () -> new Good(20));
  public static final RegistryDelegate<Good> JADE_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("jade_dragoon_spirit", () -> new Good(30));
  public static final RegistryDelegate<Good> GOLD_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("gold_dragoon_spirit", () -> new Good(40));
  public static final RegistryDelegate<Good> VIOLET_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("violet_dragoon_spirit", () -> new Good(50));
  public static final RegistryDelegate<Good> SILVER_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("silver_dragoon_spirit", () -> new Good(60));
  public static final RegistryDelegate<Good> DARK_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("dark_dragoon_spirit", () -> new Good(70));
  public static final RegistryDelegate<Good> DIVINE_DRAGOON_SPIRIT = GOODS_REGISTRAR.register("divine_dragoon_spirit", () -> new Good(80));
  ...
  public static final RegistryDelegate<Good> AXE_FROM_THE_SHACK = GOODS_REGISTRAR.register("axe_from_shack", () -> new Good(120));
  public static final RegistryDelegate<Good> GOOD_SPIRITS = GOODS_REGISTRAR.register("good_spirits", () -> new Good(130));
  public static final RegistryDelegate<Good> SHINY_BAG = GOODS_REGISTRAR.register("shiny_bag", () -> new Good(140));
  public static final RegistryDelegate<Good> WATER_BOTTLE = GOODS_REGISTRAR.register("water_bottle", () -> new Good(150));
  public static final RegistryDelegate<Good> LIFE_WATER = GOODS_REGISTRAR.register("life_water", () -> new Good(160));
  ...
  public static final RegistryDelegate<Good> OMEGA_BOMB = GOODS_REGISTRAR.register("omega_bomb", () -> new Good(300));
  public static final RegistryDelegate<Good> OMEGA_MASTER = GOODS_REGISTRAR.register("omega_master", () -> new Good(310));
  ...
  public static final RegistryDelegate<Good> MAGIC_SHINY_BAG = GOODS_REGISTRAR.register("magic_shiny_bag", () -> new Good(350));
