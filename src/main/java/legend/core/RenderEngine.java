...
public class RenderEngine {
  ...
  public static final ShaderType<ShaderOptionsTmd> TMD_SHADER = new ShaderType<>(
    ...
    shader -> {
      ...
      final Shader<ShaderOptionsTmd>.UniformInt time = shader.new UniformInt("time");
      return () -> new ShaderOptionsTmd(modelIndex, recolour, uvOffset, clutOverride, tpageOverride, discardTranslucency, tmdTranslucency, usePs1Depth, time);
    }
  );
  ...
  public static final ShaderType<ShaderOptionsBattleTmd> BATTLE_TMD_SHADER = new ShaderType<>(
    ...
    shader -> {
      ...
      final Shader<ShaderOptionsBattleTmd>.UniformInt time = shader.new UniformInt("time");
      return () -> new ShaderOptionsBattleTmd(modelIndex, recolour, uvOffset, clutOverride, tpageOverride, discardTranslucency, tmdTranslucency, usePs1Depth, ctmdFlags, battleColour, time);
    }
  );
