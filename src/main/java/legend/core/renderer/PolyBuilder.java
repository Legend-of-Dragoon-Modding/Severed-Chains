...
public class PolyBuilder {
  ...
  private final VertexOrder vertexOrder;
  ...
  private BufferUsage bufferUsage = BufferUsage.STATIC;
  ...
  public PolyBuilder(final String name) {
    this(name, VertexOrder.TRIANGLES);
  }

  public PolyBuilder(final String name, final VertexOrder vertexOrder) {
    this.name = name;
    this.vertexOrder = vertexOrder;
  }

  public PolyBuilder bufferUsage(final BufferUsage bufferUsage) {
