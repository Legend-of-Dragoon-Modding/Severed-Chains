...
public class SimpleShaderOptions implements ShaderOptions {
  private final ShaderUniformVec2 shiftUvUniform;
  private final ShaderUniformVec4 recolourUniform;

  private final Vector2f shiftUv = new Vector2f();
  private final Vector4f recolour = new Vector4f();

  public SimpleShaderOptions(final ShaderUniformVec2 shiftUvUniform, final ShaderUniformVec4 recolourUniform) {
