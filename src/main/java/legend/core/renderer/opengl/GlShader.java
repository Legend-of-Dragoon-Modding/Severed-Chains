...
public class GlShader<Options extends ShaderOptions> implements Shader<Options> {
  ...
  public GlShader(final Path vert, final Path frag, final Function<Shader<Options>, Supplier<Options>> options) throws IOException {
  ...
  public GlShader(final Path vert, final Path geom, final Path frag, final Function<Shader<Options>, Supplier<Options>> options) throws IOException {
