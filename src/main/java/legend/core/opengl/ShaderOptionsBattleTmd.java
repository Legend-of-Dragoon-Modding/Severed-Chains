...
public class ShaderOptionsBattleTmd extends ShaderOptionsBase<ShaderOptionsBattleTmd> {
  ...
  public ShaderOptionsBattleTmd(final Shader<ShaderOptionsBattleTmd>.UniformFloat modelIndex, final Shader<ShaderOptionsBattleTmd>.UniformVec3 colourUniform, final Shader<ShaderOptionsBattleTmd>.UniformVec2 uvOffsetUniform, final Shader<ShaderOptionsBattleTmd>.UniformVec2 clutUniform, final Shader<ShaderOptionsBattleTmd>.UniformVec2 tpageUniform, final Shader<ShaderOptionsBattleTmd>.UniformFloat discardTranslucency, final Shader<ShaderOptionsBattleTmd>.UniformInt tmdTranslucency, final Shader<ShaderOptionsBattleTmd>.UniformInt usePs1Depth, final Shader<ShaderOptionsBattleTmd>.UniformInt ctmdFlags, final Shader<ShaderOptionsBattleTmd>.UniformVec3 battleColour, final Shader<ShaderOptionsBattleTmd>.UniformInt time) {
